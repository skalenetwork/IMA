...
export async function deployContractManager(contractManagerAddress: string) {
    ...
    if (await instance.getContract("KeyStorage") === "0x0000000000000000000000000000000000000000") {
        ...
        await instance.setContractsAddress("KeyStorage", await keyStorageInstance.getAddress());
    }
    if (await instance.getContract(nameNodes) === "0x0000000000000000000000000000000000000000") {
        ...
        await instance.setContractsAddress(nameNodes, await nodesInstance.getAddress());
    }
    if (await instance.getContract(nameSchains) === "0x0000000000000000000000000000000000000000") {
        ...
        await schainsInstance.addContractManager(await instance.getAddress());
        await instance.setContractsAddress(nameSchains, await schainsInstance.getAddress());
    }
    if (await instance.getContract(nameSchainsInternal) === "0x0000000000000000000000000000000000000000") {
        ...
        await schainsInternalInstance.addContractManager(await instance.getAddress());
        await instance.setContractsAddress(nameSchainsInternal, await schainsInternalInstance.getAddress());
    }
    if (await instance.getContract(nameSkaleVerifier) === "0x0000000000000000000000000000000000000000") {
        ...
        await instance.setContractsAddress("SkaleVerifier", await skaleVerifierInstance.getAddress());
    }
    if (await instance.getContract(nameWallets) === "0x0000000000000000000000000000000000000000") {
        ...
        await walletsInstance.addContractManager(await instance.getAddress());
        await instance.setContractsAddress(nameWallets, await walletsInstance.getAddress());
    }
    return instance;
}
