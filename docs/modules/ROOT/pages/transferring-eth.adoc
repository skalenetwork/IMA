...
Using https://www.npmjs.com/package/@skalenetwork/ima-js[ima-js: https://www.npmjs.com/package/@skalenetwork/ima-js], use `depositETHtoSChain()` from the MainnetChain object. link:{eth-ima-js-sandbox}?file=/src/deposit.js[See IMA-JS deposit.js sandbox]
...
Using https://www.npmjs.com/package/@skalenetwork/ima-js[ima-js: https://www.npmjs.com/package/@skalenetwork/ima-js], use `withdrawETH()` from the SChain object. link:{eth-ima-js-sandbox}?file=/src/exit.js[See IMA-JS exit.js sandbox]
...
Using https://www.npmjs.com/package/@skalenetwork/ima-js[ima-js: https://www.npmjs.com/package/@skalenetwork/ima-js], use `getMyEth()` from the Mainnet object. link:{eth-ima-js-sandbox}?file=/src/getMyEth.js[See IMA-JS getMyEth.js sandbox]
