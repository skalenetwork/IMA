= 🛠️ Development with IMA-SDK and IMA-JS
...
[NOTE]
This article assumes that you're already have IMA-SDK with deployment contracts running. To setup IMA-SDK refer to xref:develop::ima-sdk.adoc[this doc].
