...
To send ERC721 tokens from a user's wallet to the IMA Deposit Box on Ethereum, you will need to use the https://github.com/skalenetwork/IMA/blob/develop/proxy/contracts/DepositBoxERC721.sol#L142[depositERC721] function within the **DepositBoxERC721** IMA contract on Ethereum.
