...
https://codesandbox.io/s/erc1155-transfer-skale-interchain-messaging-agent-forked-hwexm[Live ERC1155 IMA Demo]

=== 1. Deposit ERC1155 on Ethereum

To send ERC1155 tokens from a user's wallet to the IMA Deposit Box on Ethereum, you will need to use the https://github.com/skalenetwork/IMA/blob/develop/proxy/contracts/DepositBoxERC1155.sol#L142[depositERC1155] function within the **DepositBoxERC1155** IMA contract on Ethereum.
