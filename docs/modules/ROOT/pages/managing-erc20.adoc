...
[source,javascript]
----
import IMA from '@skalenetwork/ima';

let erc20Name = "sm";
let MAX_APPROVAL_AMOUNT = 10;
let SCHAIN_NAME = "[YOUR_SKALE_CHAIN_NAME]";
let address 

ima.mainnet.approveERC20Transfers(erc20Name, constants.MAX_APPROVAL_AMOUNT, opts);
ima.depositERC20(SCHAIN_NAME, erc20Name, address, value, opts);
----
