...
export async function linkERC721TokenOrigin(ima) {
    ...
    const isERC721AddedOrigin = await ima.schain.erc721.isTokenAdded(erc721OnOrigin);
    if (isERC721AddedOrigin === ZERO_ADDRESS) {
        await ima.schain.erc721.addTokenByOwner(
            targetChainName,
            erc721OnOrigin,
            erc721OnTarget,
            opts
