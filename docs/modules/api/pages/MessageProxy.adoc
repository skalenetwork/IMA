...
:registryContracts: pass:normal[xref:#MessageProxy-registryContracts-mapping-bytes32----mapping-address----bool--[`++registryContracts++`]]
...
:addConnectedChain: pass:normal[xref:#MessageProxy-addConnectedChain-string-[`++addConnectedChain++`]]
...
:postIncomingMessages: pass:normal[xref:#MessageProxy-postIncomingMessages-string-uint256-struct-MessageProxy-Message---struct-MessageProxy-Signature-[`++postIncomingMessages++`]]
...
:isContractRegistered: pass:normal[xref:#MessageProxy-isContractRegistered-string-address-[`++isContractRegistered++`]]
...
:_callReceiverContract: pass:normal[xref:#MessageProxy-_callReceiverContract-bytes32-struct-MessageProxy-Message-uint256-[`++_callReceiverContract++`]]
:_getGasPayer: pass:normal[xref:#MessageProxy-_getGasPayer-bytes32-struct-MessageProxy-Message-uint256-[`++_getGasPayer++`]]
...
:_hashedArray: pass:normal[xref:#MessageProxy-_hashedArray-struct-MessageProxy-Message---[`++_hashedArray++`]]
...
* {xref-MessageProxy-addConnectedChain-string-}[`++addConnectedChain(schainName)++`]
...
* {xref-MessageProxy-postIncomingMessages-string-uint256-struct-MessageProxy-Message---struct-MessageProxy-Signature-}[`++postIncomingMessages(fromSchainName, startingCounter, messages, sign)++`]
...
* {xref-MessageProxy-isContractRegistered-string-address-}[`++isContractRegistered(schainName, contractAddress)++`]
...
* {xref-MessageProxy-_callReceiverContract-bytes32-struct-MessageProxy-Message-uint256-}[`++_callReceiverContract(schainHash, message, counter)++`]
* {xref-MessageProxy-_getGasPayer-bytes32-struct-MessageProxy-Message-uint256-}[`++_getGasPayer(schainHash, message, counter)++`]
...
* {xref-MessageProxy-_hashedArray-struct-MessageProxy-Message---}[`++_hashedArray(messages)++`]
--
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-addConnectedChain-string->addConnectedChain</a>+++ `++addConnectedChain(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++)++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-isContractRegistered-string-address->isContractRegistered</a>+++ `++isContractRegistered(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++, ++[.var-type]#++address++#++ ++[.var-name]#++contractAddress++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-_callReceiverContract-bytes32-struct-MessageProxy-Message-uint256->_callReceiverContract</a>+++ `++_callReceiverContract(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++struct MessageProxy.Message++#++ ++[.var-name]#++message++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++counter++#++) → ++[.var-type]#++address++#++++` [.item-kind]#internal#

Allows MessageProxy to send messages from schain to mainnet.
Destination contract must implement `postMessage` method.

[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-_getGasPayer-bytes32-struct-MessageProxy-Message-uint256->_getGasPayer</a>+++ `++_getGasPayer(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++struct MessageProxy.Message++#++ ++[.var-name]#++message++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++counter++#++) → ++[.var-type]#++address++#++++` [.item-kind]#internal#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-_hashedArray-struct-MessageProxy-Message--->_hashedArray</a>+++ `++_hashedArray(++[.var-type]#++struct MessageProxy.Message[]++#++ ++[.var-name]#++messages++#++) → ++[.var-type]#++bytes32++#++++` [.item-kind]#internal#
