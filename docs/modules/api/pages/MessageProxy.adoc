:MessageProxy: pass:normal[xref:#MessageProxy[`MessageProxy`]]
:xref-MessageProxy: xref:#MessageProxy
:MessageProxy-onlyChainConnector: pass:normal[xref:#MessageProxy-onlyChainConnector--[`MessageProxy.onlyChainConnector`]]
:xref-MessageProxy-onlyChainConnector--: xref:#MessageProxy-onlyChainConnector--
:MessageProxy-onlyExtraContractRegistrar: pass:normal[xref:#MessageProxy-onlyExtraContractRegistrar--[`MessageProxy.onlyExtraContractRegistrar`]]
:xref-MessageProxy-onlyExtraContractRegistrar--: xref:#MessageProxy-onlyExtraContractRegistrar--
:MessageProxy-onlyConstantSetter: pass:normal[xref:#MessageProxy-onlyConstantSetter--[`MessageProxy.onlyConstantSetter`]]
:xref-MessageProxy-onlyConstantSetter--: xref:#MessageProxy-onlyConstantSetter--
:MessageProxy-MAINNET_HASH: pass:normal[xref:#MessageProxy-MAINNET_HASH-bytes32[`MessageProxy.MAINNET_HASH`]]
:xref-MessageProxy-MAINNET_HASH-bytes32: xref:#MessageProxy-MAINNET_HASH-bytes32
:MessageProxy-CHAIN_CONNECTOR_ROLE: pass:normal[xref:#MessageProxy-CHAIN_CONNECTOR_ROLE-bytes32[`MessageProxy.CHAIN_CONNECTOR_ROLE`]]
:xref-MessageProxy-CHAIN_CONNECTOR_ROLE-bytes32: xref:#MessageProxy-CHAIN_CONNECTOR_ROLE-bytes32
:MessageProxy-EXTRA_CONTRACT_REGISTRAR_ROLE: pass:normal[xref:#MessageProxy-EXTRA_CONTRACT_REGISTRAR_ROLE-bytes32[`MessageProxy.EXTRA_CONTRACT_REGISTRAR_ROLE`]]
:xref-MessageProxy-EXTRA_CONTRACT_REGISTRAR_ROLE-bytes32: xref:#MessageProxy-EXTRA_CONTRACT_REGISTRAR_ROLE-bytes32
:MessageProxy-CONSTANT_SETTER_ROLE: pass:normal[xref:#MessageProxy-CONSTANT_SETTER_ROLE-bytes32[`MessageProxy.CONSTANT_SETTER_ROLE`]]
:xref-MessageProxy-CONSTANT_SETTER_ROLE-bytes32: xref:#MessageProxy-CONSTANT_SETTER_ROLE-bytes32
:MessageProxy-MESSAGES_LENGTH: pass:normal[xref:#MessageProxy-MESSAGES_LENGTH-uint256[`MessageProxy.MESSAGES_LENGTH`]]
:xref-MessageProxy-MESSAGES_LENGTH-uint256: xref:#MessageProxy-MESSAGES_LENGTH-uint256
:MessageProxy-REVERT_REASON_LENGTH: pass:normal[xref:#MessageProxy-REVERT_REASON_LENGTH-uint256[`MessageProxy.REVERT_REASON_LENGTH`]]
:xref-MessageProxy-REVERT_REASON_LENGTH-uint256: xref:#MessageProxy-REVERT_REASON_LENGTH-uint256
:MessageProxy-connectedChains: pass:normal[xref:#MessageProxy-connectedChains-mapping-bytes32----struct-MessageProxy-ConnectedChainInfo-[`MessageProxy.connectedChains`]]
:xref-MessageProxy-connectedChains-mapping-bytes32----struct-MessageProxy-ConnectedChainInfo-: xref:#MessageProxy-connectedChains-mapping-bytes32----struct-MessageProxy-ConnectedChainInfo-
:MessageProxy-deprecatedRegistryContracts: pass:normal[xref:#MessageProxy-deprecatedRegistryContracts-mapping-bytes32----mapping-address----bool--[`MessageProxy.deprecatedRegistryContracts`]]
:xref-MessageProxy-deprecatedRegistryContracts-mapping-bytes32----mapping-address----bool--: xref:#MessageProxy-deprecatedRegistryContracts-mapping-bytes32----mapping-address----bool--
:MessageProxy-gasLimit: pass:normal[xref:#MessageProxy-gasLimit-uint256[`MessageProxy.gasLimit`]]
:xref-MessageProxy-gasLimit-uint256: xref:#MessageProxy-gasLimit-uint256
:MessageProxy-setNewGasLimit: pass:normal[xref:#MessageProxy-setNewGasLimit-uint256-[`MessageProxy.setNewGasLimit`]]
:xref-MessageProxy-setNewGasLimit-uint256-: xref:#MessageProxy-setNewGasLimit-uint256-
:MessageProxy-postIncomingMessages: pass:normal[xref:#MessageProxy-postIncomingMessages-string-uint256-struct-IMessageProxy-Message---struct-IMessageProxy-Signature-[`MessageProxy.postIncomingMessages`]]
:xref-MessageProxy-postIncomingMessages-string-uint256-struct-IMessageProxy-Message---struct-IMessageProxy-Signature-: xref:#MessageProxy-postIncomingMessages-string-uint256-struct-IMessageProxy-Message---struct-IMessageProxy-Signature-
:MessageProxy-registerExtraContractForAll: pass:normal[xref:#MessageProxy-registerExtraContractForAll-address-[`MessageProxy.registerExtraContractForAll`]]
:xref-MessageProxy-registerExtraContractForAll-address-: xref:#MessageProxy-registerExtraContractForAll-address-
:MessageProxy-removeExtraContractForAll: pass:normal[xref:#MessageProxy-removeExtraContractForAll-address-[`MessageProxy.removeExtraContractForAll`]]
:xref-MessageProxy-removeExtraContractForAll-address-: xref:#MessageProxy-removeExtraContractForAll-address-
:MessageProxy-getContractRegisteredLength: pass:normal[xref:#MessageProxy-getContractRegisteredLength-bytes32-[`MessageProxy.getContractRegisteredLength`]]
:xref-MessageProxy-getContractRegisteredLength-bytes32-: xref:#MessageProxy-getContractRegisteredLength-bytes32-
:MessageProxy-getContractRegisteredRange: pass:normal[xref:#MessageProxy-getContractRegisteredRange-bytes32-uint256-uint256-[`MessageProxy.getContractRegisteredRange`]]
:xref-MessageProxy-getContractRegisteredRange-bytes32-uint256-uint256-: xref:#MessageProxy-getContractRegisteredRange-bytes32-uint256-uint256-
:MessageProxy-getOutgoingMessagesCounter: pass:normal[xref:#MessageProxy-getOutgoingMessagesCounter-string-[`MessageProxy.getOutgoingMessagesCounter`]]
:xref-MessageProxy-getOutgoingMessagesCounter-string-: xref:#MessageProxy-getOutgoingMessagesCounter-string-
:MessageProxy-getIncomingMessagesCounter: pass:normal[xref:#MessageProxy-getIncomingMessagesCounter-string-[`MessageProxy.getIncomingMessagesCounter`]]
:xref-MessageProxy-getIncomingMessagesCounter-string-: xref:#MessageProxy-getIncomingMessagesCounter-string-
:MessageProxy-initializeMessageProxy: pass:normal[xref:#MessageProxy-initializeMessageProxy-uint256-[`MessageProxy.initializeMessageProxy`]]
:xref-MessageProxy-initializeMessageProxy-uint256-: xref:#MessageProxy-initializeMessageProxy-uint256-
:MessageProxy-postOutgoingMessage: pass:normal[xref:#MessageProxy-postOutgoingMessage-bytes32-address-bytes-[`MessageProxy.postOutgoingMessage`]]
:xref-MessageProxy-postOutgoingMessage-bytes32-address-bytes-: xref:#MessageProxy-postOutgoingMessage-bytes32-address-bytes-
:MessageProxy-removeConnectedChain: pass:normal[xref:#MessageProxy-removeConnectedChain-string-[`MessageProxy.removeConnectedChain`]]
:xref-MessageProxy-removeConnectedChain-string-: xref:#MessageProxy-removeConnectedChain-string-
:MessageProxy-isConnectedChain: pass:normal[xref:#MessageProxy-isConnectedChain-string-[`MessageProxy.isConnectedChain`]]
:xref-MessageProxy-isConnectedChain-string-: xref:#MessageProxy-isConnectedChain-string-
:MessageProxy-isContractRegistered: pass:normal[xref:#MessageProxy-isContractRegistered-bytes32-address-[`MessageProxy.isContractRegistered`]]
:xref-MessageProxy-isContractRegistered-bytes32-address-: xref:#MessageProxy-isContractRegistered-bytes32-address-
:MessageProxy-_registerExtraContract: pass:normal[xref:#MessageProxy-_registerExtraContract-bytes32-address-[`MessageProxy._registerExtraContract`]]
:xref-MessageProxy-_registerExtraContract-bytes32-address-: xref:#MessageProxy-_registerExtraContract-bytes32-address-
:MessageProxy-_removeExtraContract: pass:normal[xref:#MessageProxy-_removeExtraContract-bytes32-address-[`MessageProxy._removeExtraContract`]]
:xref-MessageProxy-_removeExtraContract-bytes32-address-: xref:#MessageProxy-_removeExtraContract-bytes32-address-
:MessageProxy-_addConnectedChain: pass:normal[xref:#MessageProxy-_addConnectedChain-bytes32-[`MessageProxy._addConnectedChain`]]
:xref-MessageProxy-_addConnectedChain-bytes32-: xref:#MessageProxy-_addConnectedChain-bytes32-
:MessageProxy-_callReceiverContract: pass:normal[xref:#MessageProxy-_callReceiverContract-bytes32-struct-IMessageProxy-Message-uint256-[`MessageProxy._callReceiverContract`]]
:xref-MessageProxy-_callReceiverContract-bytes32-struct-IMessageProxy-Message-uint256-: xref:#MessageProxy-_callReceiverContract-bytes32-struct-IMessageProxy-Message-uint256-
:MessageProxy-_getGasPayer: pass:normal[xref:#MessageProxy-_getGasPayer-bytes32-struct-IMessageProxy-Message-uint256-[`MessageProxy._getGasPayer`]]
:xref-MessageProxy-_getGasPayer-bytes32-struct-IMessageProxy-Message-uint256-: xref:#MessageProxy-_getGasPayer-bytes32-struct-IMessageProxy-Message-uint256-
:MessageProxy-_authorizeOutgoingMessageSender: pass:normal[xref:#MessageProxy-_authorizeOutgoingMessageSender-bytes32-[`MessageProxy._authorizeOutgoingMessageSender`]]
:xref-MessageProxy-_authorizeOutgoingMessageSender-bytes32-: xref:#MessageProxy-_authorizeOutgoingMessageSender-bytes32-
:MessageProxy-_getRegistryContracts: pass:normal[xref:#MessageProxy-_getRegistryContracts--[`MessageProxy._getRegistryContracts`]]
:xref-MessageProxy-_getRegistryContracts--: xref:#MessageProxy-_getRegistryContracts--
:MessageProxy-_hashedArray: pass:normal[xref:#MessageProxy-_hashedArray-struct-IMessageProxy-Message---uint256-string-[`MessageProxy._hashedArray`]]
:xref-MessageProxy-_hashedArray-struct-IMessageProxy-Message---uint256-string-: xref:#MessageProxy-_hashedArray-struct-IMessageProxy-Message---uint256-string-
:MessageProxy-OutgoingMessage: pass:normal[xref:#MessageProxy-OutgoingMessage-bytes32-uint256-address-address-bytes-[`MessageProxy.OutgoingMessage`]]
:xref-MessageProxy-OutgoingMessage-bytes32-uint256-address-address-bytes-: xref:#MessageProxy-OutgoingMessage-bytes32-uint256-address-address-bytes-
:MessageProxy-PostMessageError: pass:normal[xref:#MessageProxy-PostMessageError-uint256-bytes-[`MessageProxy.PostMessageError`]]
:xref-MessageProxy-PostMessageError-uint256-bytes-: xref:#MessageProxy-PostMessageError-uint256-bytes-
:MessageProxy-GasLimitWasChanged: pass:normal[xref:#MessageProxy-GasLimitWasChanged-uint256-uint256-[`MessageProxy.GasLimitWasChanged`]]
:xref-MessageProxy-GasLimitWasChanged-uint256-uint256-: xref:#MessageProxy-GasLimitWasChanged-uint256-uint256-
:MessageProxy-VersionUpdated: pass:normal[xref:#MessageProxy-VersionUpdated-string-string-[`MessageProxy.VersionUpdated`]]
:xref-MessageProxy-VersionUpdated-string-string-: xref:#MessageProxy-VersionUpdated-string-string-
:MessageProxy-ExtraContractRegistered: pass:normal[xref:#MessageProxy-ExtraContractRegistered-bytes32-address-[`MessageProxy.ExtraContractRegistered`]]
:xref-MessageProxy-ExtraContractRegistered-bytes32-address-: xref:#MessageProxy-ExtraContractRegistered-bytes32-address-
:MessageProxy-ExtraContractRemoved: pass:normal[xref:#MessageProxy-ExtraContractRemoved-bytes32-address-[`MessageProxy.ExtraContractRemoved`]]
:xref-MessageProxy-ExtraContractRemoved-bytes32-address-: xref:#MessageProxy-ExtraContractRemoved-bytes32-address-
:MessageProxy-ConnectedChainInfo: pass:normal[xref:#MessageProxy-ConnectedChainInfo[`MessageProxy.ConnectedChainInfo`]]
:xref-MessageProxy-ConnectedChainInfo: xref:#MessageProxy-ConnectedChainInfo
...
:MessageProxy: pass:normal[xref:#MessageProxy[`++MessageProxy++`]]
:onlyChainConnector: pass:normal[xref:#MessageProxy-onlyChainConnector--[`++onlyChainConnector++`]]
:onlyExtraContractRegistrar: pass:normal[xref:#MessageProxy-onlyExtraContractRegistrar--[`++onlyExtraContractRegistrar++`]]
:onlyConstantSetter: pass:normal[xref:#MessageProxy-onlyConstantSetter--[`++onlyConstantSetter++`]]
:MAINNET_HASH: pass:normal[xref:#MessageProxy-MAINNET_HASH-bytes32[`++MAINNET_HASH++`]]
:CHAIN_CONNECTOR_ROLE: pass:normal[xref:#MessageProxy-CHAIN_CONNECTOR_ROLE-bytes32[`++CHAIN_CONNECTOR_ROLE++`]]
:EXTRA_CONTRACT_REGISTRAR_ROLE: pass:normal[xref:#MessageProxy-EXTRA_CONTRACT_REGISTRAR_ROLE-bytes32[`++EXTRA_CONTRACT_REGISTRAR_ROLE++`]]
:CONSTANT_SETTER_ROLE: pass:normal[xref:#MessageProxy-CONSTANT_SETTER_ROLE-bytes32[`++CONSTANT_SETTER_ROLE++`]]
:MESSAGES_LENGTH: pass:normal[xref:#MessageProxy-MESSAGES_LENGTH-uint256[`++MESSAGES_LENGTH++`]]
:REVERT_REASON_LENGTH: pass:normal[xref:#MessageProxy-REVERT_REASON_LENGTH-uint256[`++REVERT_REASON_LENGTH++`]]
:connectedChains: pass:normal[xref:#MessageProxy-connectedChains-mapping-bytes32----struct-MessageProxy-ConnectedChainInfo-[`++connectedChains++`]]
:deprecatedRegistryContracts: pass:normal[xref:#MessageProxy-deprecatedRegistryContracts-mapping-bytes32----mapping-address----bool--[`++deprecatedRegistryContracts++`]]
:gasLimit: pass:normal[xref:#MessageProxy-gasLimit-uint256[`++gasLimit++`]]
:setNewGasLimit: pass:normal[xref:#MessageProxy-setNewGasLimit-uint256-[`++setNewGasLimit++`]]
:postIncomingMessages: pass:normal[xref:#MessageProxy-postIncomingMessages-string-uint256-struct-IMessageProxy-Message---struct-IMessageProxy-Signature-[`++postIncomingMessages++`]]
:registerExtraContractForAll: pass:normal[xref:#MessageProxy-registerExtraContractForAll-address-[`++registerExtraContractForAll++`]]
:removeExtraContractForAll: pass:normal[xref:#MessageProxy-removeExtraContractForAll-address-[`++removeExtraContractForAll++`]]
:getContractRegisteredLength: pass:normal[xref:#MessageProxy-getContractRegisteredLength-bytes32-[`++getContractRegisteredLength++`]]
:getContractRegisteredRange: pass:normal[xref:#MessageProxy-getContractRegisteredRange-bytes32-uint256-uint256-[`++getContractRegisteredRange++`]]
:getOutgoingMessagesCounter: pass:normal[xref:#MessageProxy-getOutgoingMessagesCounter-string-[`++getOutgoingMessagesCounter++`]]
:getIncomingMessagesCounter: pass:normal[xref:#MessageProxy-getIncomingMessagesCounter-string-[`++getIncomingMessagesCounter++`]]
:initializeMessageProxy: pass:normal[xref:#MessageProxy-initializeMessageProxy-uint256-[`++initializeMessageProxy++`]]
:postOutgoingMessage: pass:normal[xref:#MessageProxy-postOutgoingMessage-bytes32-address-bytes-[`++postOutgoingMessage++`]]
:removeConnectedChain: pass:normal[xref:#MessageProxy-removeConnectedChain-string-[`++removeConnectedChain++`]]
:isConnectedChain: pass:normal[xref:#MessageProxy-isConnectedChain-string-[`++isConnectedChain++`]]
:isContractRegistered: pass:normal[xref:#MessageProxy-isContractRegistered-bytes32-address-[`++isContractRegistered++`]]
:_registerExtraContract: pass:normal[xref:#MessageProxy-_registerExtraContract-bytes32-address-[`++_registerExtraContract++`]]
:_removeExtraContract: pass:normal[xref:#MessageProxy-_removeExtraContract-bytes32-address-[`++_removeExtraContract++`]]
:_addConnectedChain: pass:normal[xref:#MessageProxy-_addConnectedChain-bytes32-[`++_addConnectedChain++`]]
:_callReceiverContract: pass:normal[xref:#MessageProxy-_callReceiverContract-bytes32-struct-IMessageProxy-Message-uint256-[`++_callReceiverContract++`]]
:_getGasPayer: pass:normal[xref:#MessageProxy-_getGasPayer-bytes32-struct-IMessageProxy-Message-uint256-[`++_getGasPayer++`]]
:_authorizeOutgoingMessageSender: pass:normal[xref:#MessageProxy-_authorizeOutgoingMessageSender-bytes32-[`++_authorizeOutgoingMessageSender++`]]
:_getRegistryContracts: pass:normal[xref:#MessageProxy-_getRegistryContracts--[`++_getRegistryContracts++`]]
:_hashedArray: pass:normal[xref:#MessageProxy-_hashedArray-struct-IMessageProxy-Message---uint256-string-[`++_hashedArray++`]]
:OutgoingMessage: pass:normal[xref:#MessageProxy-OutgoingMessage-bytes32-uint256-address-address-bytes-[`++OutgoingMessage++`]]
:PostMessageError: pass:normal[xref:#MessageProxy-PostMessageError-uint256-bytes-[`++PostMessageError++`]]
:GasLimitWasChanged: pass:normal[xref:#MessageProxy-GasLimitWasChanged-uint256-uint256-[`++GasLimitWasChanged++`]]
:VersionUpdated: pass:normal[xref:#MessageProxy-VersionUpdated-string-string-[`++VersionUpdated++`]]
:ExtraContractRegistered: pass:normal[xref:#MessageProxy-ExtraContractRegistered-bytes32-address-[`++ExtraContractRegistered++`]]
:ExtraContractRemoved: pass:normal[xref:#MessageProxy-ExtraContractRemoved-bytes32-address-[`++ExtraContractRemoved++`]]
:ConnectedChainInfo: pass:normal[xref:#MessageProxy-ConnectedChainInfo[`++ConnectedChainInfo++`]]
...
.Modifiers
--
* {xref-MessageProxy-onlyChainConnector--}[`++onlyChainConnector()++`]
* {xref-MessageProxy-onlyExtraContractRegistrar--}[`++onlyExtraContractRegistrar()++`]
* {xref-MessageProxy-onlyConstantSetter--}[`++onlyConstantSetter()++`]
--

[.contract-index]
.Functions
--
* {xref-MessageProxy-setNewGasLimit-uint256-}[`++setNewGasLimit(newGasLimit)++`]
* {xref-MessageProxy-postIncomingMessages-string-uint256-struct-IMessageProxy-Message---struct-IMessageProxy-Signature-}[`++postIncomingMessages(fromSchainName, startingCounter, messages, sign)++`]
* {xref-MessageProxy-registerExtraContractForAll-address-}[`++registerExtraContractForAll(extraContract)++`]
* {xref-MessageProxy-removeExtraContractForAll-address-}[`++removeExtraContractForAll(extraContract)++`]
* {xref-MessageProxy-getContractRegisteredLength-bytes32-}[`++getContractRegisteredLength(schainHash)++`]
* {xref-MessageProxy-getContractRegisteredRange-bytes32-uint256-uint256-}[`++getContractRegisteredRange(schainHash, from, to)++`]
* {xref-MessageProxy-getOutgoingMessagesCounter-string-}[`++getOutgoingMessagesCounter(targetSchainName)++`]
* {xref-MessageProxy-getIncomingMessagesCounter-string-}[`++getIncomingMessagesCounter(fromSchainName)++`]
* {xref-MessageProxy-initializeMessageProxy-uint256-}[`++initializeMessageProxy(newGasLimit)++`]
* {xref-MessageProxy-postOutgoingMessage-bytes32-address-bytes-}[`++postOutgoingMessage(targetChainHash, targetContract, data)++`]
* {xref-MessageProxy-removeConnectedChain-string-}[`++removeConnectedChain(schainName)++`]
* {xref-MessageProxy-isConnectedChain-string-}[`++isConnectedChain(schainName)++`]
* {xref-MessageProxy-isContractRegistered-bytes32-address-}[`++isContractRegistered(schainHash, contractAddress)++`]
* {xref-MessageProxy-_registerExtraContract-bytes32-address-}[`++_registerExtraContract(chainHash, extraContract)++`]
* {xref-MessageProxy-_removeExtraContract-bytes32-address-}[`++_removeExtraContract(chainHash, extraContract)++`]
* {xref-MessageProxy-_addConnectedChain-bytes32-}[`++_addConnectedChain(schainHash)++`]
* {xref-MessageProxy-_callReceiverContract-bytes32-struct-IMessageProxy-Message-uint256-}[`++_callReceiverContract(schainHash, message, counter)++`]
* {xref-MessageProxy-_getGasPayer-bytes32-struct-IMessageProxy-Message-uint256-}[`++_getGasPayer(schainHash, message, counter)++`]
* {xref-MessageProxy-_authorizeOutgoingMessageSender-bytes32-}[`++_authorizeOutgoingMessageSender(targetChainHash)++`]
* {xref-MessageProxy-_getRegistryContracts--}[`++_getRegistryContracts()++`]
* {xref-MessageProxy-_hashedArray-struct-IMessageProxy-Message---uint256-string-}[`++_hashedArray(messages, startingCounter, fromChainName)++`]
--

[.contract-index]
.Events
--
* {xref-MessageProxy-OutgoingMessage-bytes32-uint256-address-address-bytes-}[`++OutgoingMessage(dstChainHash, msgCounter, srcContract, dstContract, data)++`]
* {xref-MessageProxy-PostMessageError-uint256-bytes-}[`++PostMessageError(msgCounter, message)++`]
* {xref-MessageProxy-GasLimitWasChanged-uint256-uint256-}[`++GasLimitWasChanged(oldValue, newValue)++`]
* {xref-MessageProxy-VersionUpdated-string-string-}[`++VersionUpdated(oldVersion, newVersion)++`]
* {xref-MessageProxy-ExtraContractRegistered-bytes32-address-}[`++ExtraContractRegistered(chainHash, contractAddress)++`]
* {xref-MessageProxy-ExtraContractRemoved-bytes32-address-}[`++ExtraContractRemoved(chainHash, contractAddress)++`]
--

[.contract-item]
[[MessageProxy-onlyChainConnector--]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-onlyChainConnector-->onlyChainConnector</a>+++ `++onlyChainConnector()++` [.item-kind]#modifier#

Modifier to make a function callable only if caller is granted with {CHAIN_CONNECTOR_ROLE}.

[.contract-item]
[[MessageProxy-onlyExtraContractRegistrar--]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-onlyExtraContractRegistrar-->onlyExtraContractRegistrar</a>+++ `++onlyExtraContractRegistrar()++` [.item-kind]#modifier#

Modifier to make a function callable only if caller is granted with {EXTRA_CONTRACT_REGISTRAR_ROLE}.

[.contract-item]
[[MessageProxy-onlyConstantSetter--]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-onlyConstantSetter-->onlyConstantSetter</a>+++ `++onlyConstantSetter()++` [.item-kind]#modifier#

Modifier to make a function callable only if caller is granted with {CONSTANT_SETTER_ROLE}.


[.contract-item]
[[MessageProxy-setNewGasLimit-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-setNewGasLimit-uint256->setNewGasLimit</a>+++ `++setNewGasLimit(++[.var-type]#++uint256++#++ ++[.var-name]#++newGasLimit++#++)++` [.item-kind]#external#
...
[.contract-item]
[[MessageProxy-postIncomingMessages-string-uint256-struct-IMessageProxy-Message---struct-IMessageProxy-Signature-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-postIncomingMessages-string-uint256-struct-IMessageProxy-Message---struct-IMessageProxy-Signature->postIncomingMessages</a>+++ `++postIncomingMessages(++[.var-type]#++string++#++ ++[.var-name]#++fromSchainName++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++startingCounter++#++, ++[.var-type]#++struct IMessageProxy.Message[]++#++ ++[.var-name]#++messages++#++, ++[.var-type]#++struct IMessageProxy.Signature++#++ ++[.var-name]#++sign++#++)++` [.item-kind]#external#

Virtual function for `postIncomingMessages`.

[.contract-item]
[[MessageProxy-registerExtraContractForAll-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-registerExtraContractForAll-address->registerExtraContractForAll</a>+++ `++registerExtraContractForAll(++[.var-type]#++address++#++ ++[.var-name]#++extraContract++#++)++` [.item-kind]#external#

Allows `msg.sender` to register extra contract for all schains
...
[.contract-item]
[[MessageProxy-removeExtraContractForAll-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-removeExtraContractForAll-address->removeExtraContractForAll</a>+++ `++removeExtraContractForAll(++[.var-type]#++address++#++ ++[.var-name]#++extraContract++#++)++` [.item-kind]#external#

Allows `msg.sender` to remove extra contract for all schains.
...
[.contract-item]
[[MessageProxy-getContractRegisteredLength-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-getContractRegisteredLength-bytes32->getContractRegisteredLength</a>+++ `++getContractRegisteredLength(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Should return length of contract registered by schainHash.

[.contract-item]
[[MessageProxy-getContractRegisteredRange-bytes32-uint256-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-getContractRegisteredRange-bytes32-uint256-uint256->getContractRegisteredRange</a>+++ `++getContractRegisteredRange(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++from++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++to++#++) → ++[.var-type]#++address[]++#++ ++[.var-name]#++contractsInRange++#++++` [.item-kind]#external#
...
[.contract-item]
[[MessageProxy-getOutgoingMessagesCounter-string-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-getOutgoingMessagesCounter-string->getOutgoingMessagesCounter</a>+++ `++getOutgoingMessagesCounter(++[.var-type]#++string++#++ ++[.var-name]#++targetSchainName++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#
...
[.contract-item]
[[MessageProxy-getIncomingMessagesCounter-string-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-getIncomingMessagesCounter-string->getIncomingMessagesCounter</a>+++ `++getIncomingMessagesCounter(++[.var-type]#++string++#++ ++[.var-name]#++fromSchainName++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#
...
[.contract-item]
[[MessageProxy-initializeMessageProxy-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-initializeMessageProxy-uint256->initializeMessageProxy</a>+++ `++initializeMessageProxy(++[.var-type]#++uint256++#++ ++[.var-name]#++newGasLimit++#++)++` [.item-kind]#public#



[.contract-item]
[[MessageProxy-postOutgoingMessage-bytes32-address-bytes-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-postOutgoingMessage-bytes32-address-bytes->postOutgoingMessage</a>+++ `++postOutgoingMessage(++[.var-type]#++bytes32++#++ ++[.var-name]#++targetChainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++targetContract++#++, ++[.var-type]#++bytes++#++ ++[.var-name]#++data++#++)++` [.item-kind]#public#

Posts message from this contract to `targetChainHash` MessageProxy contract.
...
[.contract-item]
[[MessageProxy-removeConnectedChain-string-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-removeConnectedChain-string->removeConnectedChain</a>+++ `++removeConnectedChain(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++)++` [.item-kind]#public#
...
[.contract-item]
[[MessageProxy-isConnectedChain-string-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-isConnectedChain-string->isConnectedChain</a>+++ `++isConnectedChain(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#public#

Checks whether chain is currently connected.

[.contract-item]
[[MessageProxy-isContractRegistered-bytes32-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-isContractRegistered-bytes32-address->isContractRegistered</a>+++ `++isContractRegistered(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++contractAddress++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#public#

Checks whether contract is currently registered as extra contract.

[.contract-item]
[[MessageProxy-_registerExtraContract-bytes32-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-_registerExtraContract-bytes32-address->_registerExtraContract</a>+++ `++_registerExtraContract(++[.var-type]#++bytes32++#++ ++[.var-name]#++chainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++extraContract++#++)++` [.item-kind]#internal#
...
[.contract-item]
[[MessageProxy-_removeExtraContract-bytes32-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-_removeExtraContract-bytes32-address->_removeExtraContract</a>+++ `++_removeExtraContract(++[.var-type]#++bytes32++#++ ++[.var-name]#++chainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++extraContract++#++)++` [.item-kind]#internal#
...
[.contract-item]
[[MessageProxy-_addConnectedChain-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-_addConnectedChain-bytes32->_addConnectedChain</a>+++ `++_addConnectedChain(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#internal#
...
[.contract-item]
[[MessageProxy-_callReceiverContract-bytes32-struct-IMessageProxy-Message-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-_callReceiverContract-bytes32-struct-IMessageProxy-Message-uint256->_callReceiverContract</a>+++ `++_callReceiverContract(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++struct IMessageProxy.Message++#++ ++[.var-name]#++message++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++counter++#++)++` [.item-kind]#internal#

Allows MessageProxy to send messages from schain to mainnet.
Destination contract must implement `postMessage` method.

[.contract-item]
[[MessageProxy-_getGasPayer-bytes32-struct-IMessageProxy-Message-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-_getGasPayer-bytes32-struct-IMessageProxy-Message-uint256->_getGasPayer</a>+++ `++_getGasPayer(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++struct IMessageProxy.Message++#++ ++[.var-name]#++message++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++counter++#++) → ++[.var-type]#++address++#++++` [.item-kind]#internal#

Returns receiver of message.

[.contract-item]
[[MessageProxy-_authorizeOutgoingMessageSender-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-_authorizeOutgoingMessageSender-bytes32->_authorizeOutgoingMessageSender</a>+++ `++_authorizeOutgoingMessageSender(++[.var-type]#++bytes32++#++ ++[.var-name]#++targetChainHash++#++)++` [.item-kind]#internal#

Checks whether msg.sender is registered as custom extra contract.

[.contract-item]
[[MessageProxy-_getRegistryContracts--]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-_getRegistryContracts-->_getRegistryContracts</a>+++ `++_getRegistryContracts() → ++[.var-type]#++mapping(bytes32 => struct EnumerableSetUpgradeable.AddressSet)++#++++` [.item-kind]#internal#

Returns list of registered custom extra contracts.

[.contract-item]
[[MessageProxy-_hashedArray-struct-IMessageProxy-Message---uint256-string-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-_hashedArray-struct-IMessageProxy-Message---uint256-string->_hashedArray</a>+++ `++_hashedArray(++[.var-type]#++struct IMessageProxy.Message[]++#++ ++[.var-name]#++messages++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++startingCounter++#++, ++[.var-type]#++string++#++ ++[.var-name]#++fromChainName++#++) → ++[.var-type]#++bytes32++#++++` [.item-kind]#internal#

Returns hash of message array.


[.contract-item]
[[MessageProxy-OutgoingMessage-bytes32-uint256-address-address-bytes-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-OutgoingMessage-bytes32-uint256-address-address-bytes->OutgoingMessage</a>+++ `++OutgoingMessage(++[.var-type]#++bytes32++#++ ++[.var-name]#++dstChainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++msgCounter++#++, ++[.var-type]#++address++#++ ++[.var-name]#++srcContract++#++, ++[.var-type]#++address++#++ ++[.var-name]#++dstContract++#++, ++[.var-type]#++bytes++#++ ++[.var-name]#++data++#++)++` [.item-kind]#event#

Emitted for every outgoing message to schain.

[.contract-item]
[[MessageProxy-PostMessageError-uint256-bytes-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-PostMessageError-uint256-bytes->PostMessageError</a>+++ `++PostMessageError(++[.var-type]#++uint256++#++ ++[.var-name]#++msgCounter++#++, ++[.var-type]#++bytes++#++ ++[.var-name]#++message++#++)++` [.item-kind]#event#

Emitted when function `postMessage` returns revert.
 Used to prevent stuck loop inside function `postIncomingMessages`.

[.contract-item]
[[MessageProxy-GasLimitWasChanged-uint256-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-GasLimitWasChanged-uint256-uint256->GasLimitWasChanged</a>+++ `++GasLimitWasChanged(++[.var-type]#++uint256++#++ ++[.var-name]#++oldValue++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++newValue++#++)++` [.item-kind]#event#

Emitted when gas limit per one call of `postMessage` was changed.

[.contract-item]
[[MessageProxy-VersionUpdated-string-string-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-VersionUpdated-string-string->VersionUpdated</a>+++ `++VersionUpdated(++[.var-type]#++string++#++ ++[.var-name]#++oldVersion++#++, ++[.var-type]#++string++#++ ++[.var-name]#++newVersion++#++)++` [.item-kind]#event#

Emitted when the version was updated

[.contract-item]
[[MessageProxy-ExtraContractRegistered-bytes32-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-ExtraContractRegistered-bytes32-address->ExtraContractRegistered</a>+++ `++ExtraContractRegistered(++[.var-type]#++bytes32++#++ ++[.var-name]#++chainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++contractAddress++#++)++` [.item-kind]#event#

Emitted when extra contract was added.

[.contract-item]
[[MessageProxy-ExtraContractRemoved-bytes32-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-ExtraContractRemoved-bytes32-address->ExtraContractRemoved</a>+++ `++ExtraContractRemoved(++[.var-type]#++bytes32++#++ ++[.var-name]#++chainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++contractAddress++#++)++` [.item-kind]#event#
