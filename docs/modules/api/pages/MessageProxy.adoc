...
:getLastOutgoingMessageBlockId: pass:normal[xref:#MessageProxy-getLastOutgoingMessageBlockId-string-[`++getLastOutgoingMessageBlockId++`]]
...
:PreviousMessageReference: pass:normal[xref:#MessageProxy-PreviousMessageReference-uint256-uint256-[`++PreviousMessageReference++`]]
...
* {xref-MessageProxy-getLastOutgoingMessageBlockId-string-}[`++getLastOutgoingMessageBlockId(targetSchainName)++`]
...
* {xref-MessageProxy-PreviousMessageReference-uint256-uint256-}[`++PreviousMessageReference(currentMessage, previousOutgoingMessageBlockId)++`]
--
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-getLastOutgoingMessageBlockId-string->getLastOutgoingMessageBlockId</a>+++ `++getLastOutgoingMessageBlockId(++[.var-type]#++string++#++ ++[.var-name]#++targetSchainName++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Should return block number of the last message transferred to schain
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxy-PreviousMessageReference-uint256-uint256->PreviousMessageReference</a>+++ `++PreviousMessageReference(++[.var-type]#++uint256++#++ ++[.var-name]#++currentMessage++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++previousOutgoingMessageBlockId++#++)++` [.item-kind]#event#

Emitted when referenced to previous outgoing message.
