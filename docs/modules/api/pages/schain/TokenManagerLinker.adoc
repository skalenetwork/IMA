...
:TokenManagerLinker: pass:normal[xref:#TokenManagerLinker[`++TokenManagerLinker++`]]
:onlyRegistrar: pass:normal[xref:#TokenManagerLinker-onlyRegistrar--[`++onlyRegistrar++`]]
:MAINNET_NAME: pass:normal[xref:#TokenManagerLinker-MAINNET_NAME-string[`++MAINNET_NAME++`]]
:MAINNET_HASH: pass:normal[xref:#TokenManagerLinker-MAINNET_HASH-bytes32[`++MAINNET_HASH++`]]
:REGISTRAR_ROLE: pass:normal[xref:#TokenManagerLinker-REGISTRAR_ROLE-bytes32[`++REGISTRAR_ROLE++`]]
:messageProxy: pass:normal[xref:#TokenManagerLinker-messageProxy-contract-MessageProxy[`++messageProxy++`]]
:linkerAddress: pass:normal[xref:#TokenManagerLinker-linkerAddress-address[`++linkerAddress++`]]
:tokenManagers: pass:normal[xref:#TokenManagerLinker-tokenManagers-contract-TokenManager--[`++tokenManagers++`]]
:interchainConnections: pass:normal[xref:#TokenManagerLinker-interchainConnections-bool[`++interchainConnections++`]]
:registerTokenManager: pass:normal[xref:#TokenManagerLinker-registerTokenManager-contract-TokenManager-[`++registerTokenManager++`]]
:removeTokenManager: pass:normal[xref:#TokenManagerLinker-removeTokenManager-contract-TokenManager-[`++removeTokenManager++`]]
:connectSchain: pass:normal[xref:#TokenManagerLinker-connectSchain-string-address---[`++connectSchain++`]]
:postMessage: pass:normal[xref:#TokenManagerLinker-postMessage-bytes32-address-bytes-[`++postMessage++`]]
:disconnectSchain: pass:normal[xref:#TokenManagerLinker-disconnectSchain-string-[`++disconnectSchain++`]]
:hasTokenManager: pass:normal[xref:#TokenManagerLinker-hasTokenManager-contract-TokenManager-[`++hasTokenManager++`]]
:hasSchain: pass:normal[xref:#TokenManagerLinker-hasSchain-string-[`++hasSchain++`]]
:initialize: pass:normal[xref:#TokenManagerLinker-initialize-contract-MessageProxy-address-[`++initialize++`]]
:InterchainConnectionAllowed: pass:normal[xref:#TokenManagerLinker-InterchainConnectionAllowed-bool-[`++InterchainConnectionAllowed++`]]
...
.Modifiers
--
* {xref-TokenManagerLinker-onlyRegistrar--}[`++onlyRegistrar()++`]
--

[.contract-index]
.Functions
--
* {xref-TokenManagerLinker-registerTokenManager-contract-TokenManager-}[`++registerTokenManager(newTokenManager)++`]
* {xref-TokenManagerLinker-removeTokenManager-contract-TokenManager-}[`++removeTokenManager(tokenManagerAddress)++`]
* {xref-TokenManagerLinker-connectSchain-string-address---}[`++connectSchain(schainName, tokenManagerAddresses)++`]
* {xref-TokenManagerLinker-postMessage-bytes32-address-bytes-}[`++postMessage(fromChainHash, sender, data)++`]
* {xref-TokenManagerLinker-disconnectSchain-string-}[`++disconnectSchain(schainName)++`]
* {xref-TokenManagerLinker-hasTokenManager-contract-TokenManager-}[`++hasTokenManager(tokenManager)++`]
* {xref-TokenManagerLinker-hasSchain-string-}[`++hasSchain(schainName)++`]
* {xref-TokenManagerLinker-initialize-contract-MessageProxy-address-}[`++initialize(newMessageProxyAddress, linker)++`]
--

[.contract-index]
.Events
--
* {xref-TokenManagerLinker-InterchainConnectionAllowed-bool-}[`++InterchainConnectionAllowed(isAllowed)++`]
--

[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerLinker-onlyRegistrar-->onlyRegistrar</a>+++ `++onlyRegistrar()++` [.item-kind]#modifier#

Modifier to make a function callable only if caller is granted with {REGISTRAR_ROLE}.


[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerLinker-registerTokenManager-contract-TokenManager->registerTokenManager</a>+++ `++registerTokenManager(++[.var-type]#++contract TokenManager++#++ ++[.var-name]#++newTokenManager++#++)++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerLinker-removeTokenManager-contract-TokenManager->removeTokenManager</a>+++ `++removeTokenManager(++[.var-type]#++contract TokenManager++#++ ++[.var-name]#++tokenManagerAddress++#++)++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerLinker-connectSchain-string-address--->connectSchain</a>+++ `++connectSchain(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++, ++[.var-type]#++address[]++#++ ++[.var-name]#++tokenManagerAddresses++#++)++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerLinker-postMessage-bytes32-address-bytes->postMessage</a>+++ `++postMessage(++[.var-type]#++bytes32++#++ ++[.var-name]#++fromChainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++sender++#++, ++[.var-type]#++bytes++#++ ++[.var-name]#++data++#++) → ++[.var-type]#++address++#++++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerLinker-disconnectSchain-string->disconnectSchain</a>+++ `++disconnectSchain(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++)++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerLinker-hasTokenManager-contract-TokenManager->hasTokenManager</a>+++ `++hasTokenManager(++[.var-type]#++contract TokenManager++#++ ++[.var-name]#++tokenManager++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Check if {tokenManager} is registered in IMA.

[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerLinker-hasSchain-string->hasSchain</a>+++ `++hasSchain(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++) → ++[.var-type]#++bool++#++ ++[.var-name]#++connected++#++++` [.item-kind]#external#

Check if SKALE chain with name {schainName} is registered in IMA.

[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerLinker-initialize-contract-MessageProxy-address->initialize</a>+++ `++initialize(++[.var-type]#++contract MessageProxy++#++ ++[.var-name]#++newMessageProxyAddress++#++, ++[.var-type]#++address++#++ ++[.var-name]#++linker++#++)++` [.item-kind]#external#

Is called once during contract deployment.


[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerLinker-InterchainConnectionAllowed-bool->InterchainConnectionAllowed</a>+++ `++InterchainConnectionAllowed(++[.var-type]#++bool++#++ ++[.var-name]#++isAllowed++#++)++` [.item-kind]#event#
