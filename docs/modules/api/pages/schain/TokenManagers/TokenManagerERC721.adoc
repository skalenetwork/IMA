...
:clonesErc721: pass:normal[xref:#TokenManagerERC721-clonesErc721-mapping-address----contract-ERC721OnChain-[`++clonesErc721++`]]
...
:addERC721TokenByOwner: pass:normal[xref:#TokenManagerERC721-addERC721TokenByOwner-address-contract-ERC721OnChain-[`++addERC721TokenByOwner++`]]
:initialize: pass:normal[xref:#TokenManagerERC721-initialize-string-contract-MessageProxyForSchain-contract-TokenManagerLinker-contract-CommunityLocker-address-[`++initialize++`]]
:ERC721TokenAdded: pass:normal[xref:#TokenManagerERC721-ERC721TokenAdded-address-address-[`++ERC721TokenAdded++`]]
:ERC721TokenCreated: pass:normal[xref:#TokenManagerERC721-ERC721TokenCreated-address-address-[`++ERC721TokenCreated++`]]
:ERC721TokenReceived: pass:normal[xref:#TokenManagerERC721-ERC721TokenReceived-address-address-uint256-[`++ERC721TokenReceived++`]]
...
* {xref-TokenManagerERC721-addERC721TokenByOwner-address-contract-ERC721OnChain-}[`++addERC721TokenByOwner(erc721OnMainnet, erc721OnSchain)++`]
* {xref-TokenManagerERC721-initialize-string-contract-MessageProxyForSchain-contract-TokenManagerLinker-contract-CommunityLocker-address-}[`++initialize(newChainName, newMessageProxy, newIMALinker, newCommunityLocker, newDepositBox)++`]
--

[.contract-index]
.Events
--
* {xref-TokenManagerERC721-ERC721TokenAdded-address-address-}[`++ERC721TokenAdded(erc721OnMainnet, erc721OnSchain)++`]
* {xref-TokenManagerERC721-ERC721TokenCreated-address-address-}[`++ERC721TokenCreated(erc721OnMainnet, erc721OnSchain)++`]
* {xref-TokenManagerERC721-ERC721TokenReceived-address-address-uint256-}[`++ERC721TokenReceived(erc721OnMainnet, erc721OnSchain, tokenId)++`]
--
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerERC721-postMessage-bytes32-address-bytes->postMessage</a>+++ `++postMessage(++[.var-type]#++bytes32++#++ ++[.var-name]#++fromChainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++sender++#++, ++[.var-type]#++bytes++#++ ++[.var-name]#++data++#++) → ++[.var-type]#++address++#++++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerERC721-addERC721TokenByOwner-address-contract-ERC721OnChain->addERC721TokenByOwner</a>+++ `++addERC721TokenByOwner(++[.var-type]#++address++#++ ++[.var-name]#++erc721OnMainnet++#++, ++[.var-type]#++contract ERC721OnChain++#++ ++[.var-name]#++erc721OnSchain++#++)++` [.item-kind]#external#

Allows Schain owner to register an ERC721 token clone in the token manager.

[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerERC721-initialize-string-contract-MessageProxyForSchain-contract-TokenManagerLinker-contract-CommunityLocker-address->initialize</a>+++ `++initialize(++[.var-type]#++string++#++ ++[.var-name]#++newChainName++#++, ++[.var-type]#++contract MessageProxyForSchain++#++ ++[.var-name]#++newMessageProxy++#++, ++[.var-type]#++contract TokenManagerLinker++#++ ++[.var-name]#++newIMALinker++#++, ++[.var-type]#++contract CommunityLocker++#++ ++[.var-name]#++newCommunityLocker++#++, ++[.var-type]#++address++#++ ++[.var-name]#++newDepositBox++#++)++` [.item-kind]#external#

Is called once during contract deployment.


[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerERC721-ERC721TokenAdded-address-address->ERC721TokenAdded</a>+++ `++ERC721TokenAdded(++[.var-type]#++address++#++ ++[.var-name]#++erc721OnMainnet++#++, ++[.var-type]#++address++#++ ++[.var-name]#++erc721OnSchain++#++)++` [.item-kind]#event#

Emitted when schain owner register new ERC721 clone.

[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerERC721-ERC721TokenCreated-address-address->ERC721TokenCreated</a>+++ `++ERC721TokenCreated(++[.var-type]#++address++#++ ++[.var-name]#++erc721OnMainnet++#++, ++[.var-type]#++address++#++ ++[.var-name]#++erc721OnSchain++#++)++` [.item-kind]#event#

Emitted when TokenManagerERC721 automatically deploys new ERC721 clone.

[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerERC721-ERC721TokenReceived-address-address-uint256->ERC721TokenReceived</a>+++ `++ERC721TokenReceived(++[.var-type]#++address++#++ ++[.var-name]#++erc721OnMainnet++#++, ++[.var-type]#++address++#++ ++[.var-name]#++erc721OnSchain++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++tokenId++#++)++` [.item-kind]#event#
