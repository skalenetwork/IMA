...
:TokenManagerERC20: pass:normal[xref:#TokenManagerERC20[`++TokenManagerERC20++`]]
:clonesErc20: pass:normal[xref:#TokenManagerERC20-clonesErc20-mapping-address----contract-ERC20OnChain-[`++clonesErc20++`]]
:totalSupplyOnMainnet: pass:normal[xref:#TokenManagerERC20-totalSupplyOnMainnet-mapping-contract-IERC20Upgradeable----uint256-[`++totalSupplyOnMainnet++`]]
:addedClones: pass:normal[xref:#TokenManagerERC20-addedClones-mapping-contract-ERC20OnChain----bool-[`++addedClones++`]]
:exitToMainERC20: pass:normal[xref:#TokenManagerERC20-exitToMainERC20-address-uint256-[`++exitToMainERC20++`]]
:transferToSchainERC20: pass:normal[xref:#TokenManagerERC20-transferToSchainERC20-string-address-uint256-[`++transferToSchainERC20++`]]
:postMessage: pass:normal[xref:#TokenManagerERC20-postMessage-bytes32-address-bytes-[`++postMessage++`]]
:addERC20TokenByOwner: pass:normal[xref:#TokenManagerERC20-addERC20TokenByOwner-address-contract-ERC20OnChain-[`++addERC20TokenByOwner++`]]
:initialize: pass:normal[xref:#TokenManagerERC20-initialize-string-contract-MessageProxyForSchain-contract-TokenManagerLinker-contract-CommunityLocker-address-[`++initialize++`]]
:ERC20TokenAdded: pass:normal[xref:#TokenManagerERC20-ERC20TokenAdded-address-address-[`++ERC20TokenAdded++`]]
:ERC20TokenCreated: pass:normal[xref:#TokenManagerERC20-ERC20TokenCreated-address-address-[`++ERC20TokenCreated++`]]
:ERC20TokenReceived: pass:normal[xref:#TokenManagerERC20-ERC20TokenReceived-address-address-uint256-[`++ERC20TokenReceived++`]]
...
.Functions
--
* {xref-TokenManagerERC20-exitToMainERC20-address-uint256-}[`++exitToMainERC20(contractOnMainnet, amount)++`]
* {xref-TokenManagerERC20-transferToSchainERC20-string-address-uint256-}[`++transferToSchainERC20(targetSchainName, contractOnMainnet, amount)++`]
* {xref-TokenManagerERC20-postMessage-bytes32-address-bytes-}[`++postMessage(fromChainHash, sender, data)++`]
* {xref-TokenManagerERC20-addERC20TokenByOwner-address-contract-ERC20OnChain-}[`++addERC20TokenByOwner(erc20OnMainnet, erc20OnSchain)++`]
* {xref-TokenManagerERC20-initialize-string-contract-MessageProxyForSchain-contract-TokenManagerLinker-contract-CommunityLocker-address-}[`++initialize(newChainName, newMessageProxy, newIMALinker, newCommunityLocker, newDepositBox)++`]
--

[.contract-index]
.Events
--
* {xref-TokenManagerERC20-ERC20TokenAdded-address-address-}[`++ERC20TokenAdded(erc20OnMainnet, erc20OnSchain)++`]
* {xref-TokenManagerERC20-ERC20TokenCreated-address-address-}[`++ERC20TokenCreated(erc20OnMainnet, erc20OnSchain)++`]
* {xref-TokenManagerERC20-ERC20TokenReceived-address-address-uint256-}[`++ERC20TokenReceived(erc20OnMainnet, erc20OnSchain, amount)++`]
--


[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerERC20-exitToMainERC20-address-uint256->exitToMainERC20</a>+++ `++exitToMainERC20(++[.var-type]#++address++#++ ++[.var-name]#++contractOnMainnet++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++amount++#++)++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerERC20-transferToSchainERC20-string-address-uint256->transferToSchainERC20</a>+++ `++transferToSchainERC20(++[.var-type]#++string++#++ ++[.var-name]#++targetSchainName++#++, ++[.var-type]#++address++#++ ++[.var-name]#++contractOnMainnet++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++amount++#++)++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerERC20-postMessage-bytes32-address-bytes->postMessage</a>+++ `++postMessage(++[.var-type]#++bytes32++#++ ++[.var-name]#++fromChainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++sender++#++, ++[.var-type]#++bytes++#++ ++[.var-name]#++data++#++) → ++[.var-type]#++address++#++++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerERC20-addERC20TokenByOwner-address-contract-ERC20OnChain->addERC20TokenByOwner</a>+++ `++addERC20TokenByOwner(++[.var-type]#++address++#++ ++[.var-name]#++erc20OnMainnet++#++, ++[.var-type]#++contract ERC20OnChain++#++ ++[.var-name]#++erc20OnSchain++#++)++` [.item-kind]#external#

Allows Schain owner to register an ERC20 token clone in the token manager.

[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerERC20-initialize-string-contract-MessageProxyForSchain-contract-TokenManagerLinker-contract-CommunityLocker-address->initialize</a>+++ `++initialize(++[.var-type]#++string++#++ ++[.var-name]#++newChainName++#++, ++[.var-type]#++contract MessageProxyForSchain++#++ ++[.var-name]#++newMessageProxy++#++, ++[.var-type]#++contract TokenManagerLinker++#++ ++[.var-name]#++newIMALinker++#++, ++[.var-type]#++contract CommunityLocker++#++ ++[.var-name]#++newCommunityLocker++#++, ++[.var-type]#++address++#++ ++[.var-name]#++newDepositBox++#++)++` [.item-kind]#external#

Is called once during contract deployment.


[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerERC20-ERC20TokenAdded-address-address->ERC20TokenAdded</a>+++ `++ERC20TokenAdded(++[.var-type]#++address++#++ ++[.var-name]#++erc20OnMainnet++#++, ++[.var-type]#++address++#++ ++[.var-name]#++erc20OnSchain++#++)++` [.item-kind]#event#

Emitted when schain owner register new ERC20 clone.

[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerERC20-ERC20TokenCreated-address-address->ERC20TokenCreated</a>+++ `++ERC20TokenCreated(++[.var-type]#++address++#++ ++[.var-name]#++erc20OnMainnet++#++, ++[.var-type]#++address++#++ ++[.var-name]#++erc20OnSchain++#++)++` [.item-kind]#event#

Emitted when TokenManagerERC20 automatically deploys new ERC20 clone.

[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManagerERC20-ERC20TokenReceived-address-address-uint256->ERC20TokenReceived</a>+++ `++ERC20TokenReceived(++[.var-type]#++address++#++ ++[.var-name]#++erc20OnMainnet++#++, ++[.var-type]#++address++#++ ++[.var-name]#++erc20OnSchain++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++amount++#++)++` [.item-kind]#event#
