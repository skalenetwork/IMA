...
:messageProxy: pass:normal[xref:#CommunityLocker-messageProxy-contract-MessageProxyForSchain[`++messageProxy++`]]
:tokenManagerLinker: pass:normal[xref:#CommunityLocker-tokenManagerLinker-contract-TokenManagerLinker[`++tokenManagerLinker++`]]
...
:initialize: pass:normal[xref:#CommunityLocker-initialize-string-contract-MessageProxyForSchain-contract-TokenManagerLinker-address-[`++initialize++`]]
...
:TimeLimitPerMessageWasChanged: pass:normal[xref:#CommunityLocker-TimeLimitPerMessageWasChanged-uint256-uint256-[`++TimeLimitPerMessageWasChanged++`]]
...
* {xref-CommunityLocker-initialize-string-contract-MessageProxyForSchain-contract-TokenManagerLinker-address-}[`++initialize(newSchainName, newMessageProxy, newTokenManagerLinker, newCommunityPool)++`]
--
...
* {xref-CommunityLocker-TimeLimitPerMessageWasChanged-uint256-uint256-}[`++TimeLimitPerMessageWasChanged(oldValue, newValue)++`]
--
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityLocker-initialize-string-contract-MessageProxyForSchain-contract-TokenManagerLinker-address->initialize</a>+++ `++initialize(++[.var-type]#++string++#++ ++[.var-name]#++newSchainName++#++, ++[.var-type]#++contract MessageProxyForSchain++#++ ++[.var-name]#++newMessageProxy++#++, ++[.var-type]#++contract TokenManagerLinker++#++ ++[.var-name]#++newTokenManagerLinker++#++, ++[.var-type]#++address++#++ ++[.var-name]#++newCommunityPool++#++)++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityLocker-TimeLimitPerMessageWasChanged-uint256-uint256->TimeLimitPerMessageWasChanged</a>+++ `++TimeLimitPerMessageWasChanged(++[.var-type]#++uint256++#++ ++[.var-name]#++oldValue++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++newValue++#++)++` [.item-kind]#event#
