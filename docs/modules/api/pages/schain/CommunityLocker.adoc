...
:CommunityLocker: pass:normal[xref:#CommunityLocker[`++CommunityLocker++`]]
:MAINNET_NAME: pass:normal[xref:#CommunityLocker-MAINNET_NAME-string[`++MAINNET_NAME++`]]
:MAINNET_HASH: pass:normal[xref:#CommunityLocker-MAINNET_HASH-bytes32[`++MAINNET_HASH++`]]
:CONSTANT_SETTER_ROLE: pass:normal[xref:#CommunityLocker-CONSTANT_SETTER_ROLE-bytes32[`++CONSTANT_SETTER_ROLE++`]]
:messageProxy: pass:normal[xref:#CommunityLocker-messageProxy-contract-IMessageProxyForSchain[`++messageProxy++`]]
:tokenManagerLinker: pass:normal[xref:#CommunityLocker-tokenManagerLinker-contract-ITokenManagerLinker[`++tokenManagerLinker++`]]
:communityPool: pass:normal[xref:#CommunityLocker-communityPool-address[`++communityPool++`]]
:schainHash: pass:normal[xref:#CommunityLocker-schainHash-bytes32[`++schainHash++`]]
:timeLimitPerMessage: pass:normal[xref:#CommunityLocker-timeLimitPerMessage-uint256[`++timeLimitPerMessage++`]]
:activeUsers: pass:normal[xref:#CommunityLocker-activeUsers-mapping-address----bool-[`++activeUsers++`]]
:lastMessageTimeStamp: pass:normal[xref:#CommunityLocker-lastMessageTimeStamp-mapping-address----uint256-[`++lastMessageTimeStamp++`]]
:mainnetGasPrice: pass:normal[xref:#CommunityLocker-mainnetGasPrice-uint256[`++mainnetGasPrice++`]]
:gasPriceTimestamp: pass:normal[xref:#CommunityLocker-gasPriceTimestamp-uint256[`++gasPriceTimestamp++`]]
:postMessage: pass:normal[xref:#CommunityLocker-postMessage-bytes32-address-bytes-[`++postMessage++`]]
:checkAllowedToSendMessage: pass:normal[xref:#CommunityLocker-checkAllowedToSendMessage-address-[`++checkAllowedToSendMessage++`]]
:setTimeLimitPerMessage: pass:normal[xref:#CommunityLocker-setTimeLimitPerMessage-uint256-[`++setTimeLimitPerMessage++`]]
:setGasPrice: pass:normal[xref:#CommunityLocker-setGasPrice-uint256-uint256-struct-IMessageProxy-Signature-[`++setGasPrice++`]]
:initialize: pass:normal[xref:#CommunityLocker-initialize-string-contract-IMessageProxyForSchain-contract-ITokenManagerLinker-address-[`++initialize++`]]
:ActivateUser: pass:normal[xref:#CommunityLocker-ActivateUser-bytes32-address-[`++ActivateUser++`]]
:LockUser: pass:normal[xref:#CommunityLocker-LockUser-bytes32-address-[`++LockUser++`]]
:ConstantUpdated: pass:normal[xref:#CommunityLocker-ConstantUpdated-bytes32-uint256-uint256-[`++ConstantUpdated++`]]

[.contract]
[[CommunityLocker]]
= CommunityLocker

Contract contains logic to perform automatic reimbursement
...
.Functions
--
* {xref-CommunityLocker-postMessage-bytes32-address-bytes-}[`++postMessage(fromChainHash, sender, data)++`]
* {xref-CommunityLocker-checkAllowedToSendMessage-address-}[`++checkAllowedToSendMessage(receiver)++`]
* {xref-CommunityLocker-setTimeLimitPerMessage-uint256-}[`++setTimeLimitPerMessage(newTimeLimitPerMessage)++`]
* {xref-CommunityLocker-setGasPrice-uint256-uint256-struct-IMessageProxy-Signature-}[`++setGasPrice(gasPrice, timestamp, _)++`]
* {xref-CommunityLocker-initialize-string-contract-IMessageProxyForSchain-contract-ITokenManagerLinker-address-}[`++initialize(newSchainName, newMessageProxy, newTokenManagerLinker, newCommunityPool)++`]
--

[.contract-index]
.Events
--
* {xref-CommunityLocker-ActivateUser-bytes32-address-}[`++ActivateUser(schainHash, user)++`]
* {xref-CommunityLocker-LockUser-bytes32-address-}[`++LockUser(schainHash, user)++`]
* {xref-CommunityLocker-ConstantUpdated-bytes32-uint256-uint256-}[`++ConstantUpdated(constantHash, previousValue, newValue)++`]
--


[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityLocker-postMessage-bytes32-address-bytes->postMessage</a>+++ `++postMessage(++[.var-type]#++bytes32++#++ ++[.var-name]#++fromChainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++sender++#++, ++[.var-type]#++bytes++#++ ++[.var-name]#++data++#++) → ++[.var-type]#++address++#++++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityLocker-checkAllowedToSendMessage-address->checkAllowedToSendMessage</a>+++ `++checkAllowedToSendMessage(++[.var-type]#++address++#++ ++[.var-name]#++receiver++#++)++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityLocker-setTimeLimitPerMessage-uint256->setTimeLimitPerMessage</a>+++ `++setTimeLimitPerMessage(++[.var-type]#++uint256++#++ ++[.var-name]#++newTimeLimitPerMessage++#++)++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityLocker-setGasPrice-uint256-uint256-struct-IMessageProxy-Signature->setGasPrice</a>+++ `++setGasPrice(++[.var-type]#++uint256++#++ ++[.var-name]#++gasPrice++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++timestamp++#++, ++[.var-type]#++struct IMessageProxy.Signature++#++)++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityLocker-initialize-string-contract-IMessageProxyForSchain-contract-ITokenManagerLinker-address->initialize</a>+++ `++initialize(++[.var-type]#++string++#++ ++[.var-name]#++newSchainName++#++, ++[.var-type]#++contract IMessageProxyForSchain++#++ ++[.var-name]#++newMessageProxy++#++, ++[.var-type]#++contract ITokenManagerLinker++#++ ++[.var-name]#++newTokenManagerLinker++#++, ++[.var-type]#++address++#++ ++[.var-name]#++newCommunityPool++#++)++` [.item-kind]#external#

Is called once during contract deployment.


[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityLocker-ActivateUser-bytes32-address->ActivateUser</a>+++ `++ActivateUser(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++user++#++)++` [.item-kind]#event#

Emitted when a user becomes active.

[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityLocker-LockUser-bytes32-address->LockUser</a>+++ `++LockUser(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++user++#++)++` [.item-kind]#event#

Emitted when a user stops being active.

[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityLocker-ConstantUpdated-bytes32-uint256-uint256->ConstantUpdated</a>+++ `++ConstantUpdated(++[.var-type]#++bytes32++#++ ++[.var-name]#++constantHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++previousValue++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++newValue++#++)++` [.item-kind]#event#
