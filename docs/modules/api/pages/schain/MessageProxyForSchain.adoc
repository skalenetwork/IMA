...
:initializeAllRegisteredContracts: pass:normal[xref:#MessageProxyForSchain-initializeAllRegisteredContracts-bytes32-address---[`++initializeAllRegisteredContracts++`]]
...
.Functions
--
* {xref-MessageProxyForSchain-initializeAllRegisteredContracts-bytes32-address---}[`++initializeAllRegisteredContracts(chainHash, contracts)++`]
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-initializeAllRegisteredContracts-bytes32-address--->initializeAllRegisteredContracts</a>+++ `++initializeAllRegisteredContracts(++[.var-type]#++bytes32++#++ ++[.var-name]#++chainHash++#++, ++[.var-type]#++address[]++#++ ++[.var-name]#++contracts++#++)++` [.item-kind]#external#
