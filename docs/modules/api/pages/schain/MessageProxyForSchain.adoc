...
:MessageProxyForSchain: pass:normal[xref:#MessageProxyForSchain[`MessageProxyForSchain`]]
:xref-MessageProxyForSchain: xref:#MessageProxyForSchain
:MessageProxyForSchain-messageInProgressLocker: pass:normal[xref:#MessageProxyForSchain-messageInProgressLocker--[`MessageProxyForSchain.messageInProgressLocker`]]
:xref-MessageProxyForSchain-messageInProgressLocker--: xref:#MessageProxyForSchain-messageInProgressLocker--
:MessageProxyForSchain-ETHERBASE: pass:normal[xref:#MessageProxyForSchain-ETHERBASE-contract-IEtherbaseUpgradeable[`MessageProxyForSchain.ETHERBASE`]]
:xref-MessageProxyForSchain-ETHERBASE-contract-IEtherbaseUpgradeable: xref:#MessageProxyForSchain-ETHERBASE-contract-IEtherbaseUpgradeable
:MessageProxyForSchain-MINIMUM_BALANCE: pass:normal[xref:#MessageProxyForSchain-MINIMUM_BALANCE-uint256[`MessageProxyForSchain.MINIMUM_BALANCE`]]
:xref-MessageProxyForSchain-MINIMUM_BALANCE-uint256: xref:#MessageProxyForSchain-MINIMUM_BALANCE-uint256
:MessageProxyForSchain-keyStorage: pass:normal[xref:#MessageProxyForSchain-keyStorage-contract-IKeyStorage[`MessageProxyForSchain.keyStorage`]]
:xref-MessageProxyForSchain-keyStorage-contract-IKeyStorage: xref:#MessageProxyForSchain-keyStorage-contract-IKeyStorage
:MessageProxyForSchain-schainHash: pass:normal[xref:#MessageProxyForSchain-schainHash-bytes32[`MessageProxyForSchain.schainHash`]]
:xref-MessageProxyForSchain-schainHash-bytes32: xref:#MessageProxyForSchain-schainHash-bytes32
:MessageProxyForSchain-version: pass:normal[xref:#MessageProxyForSchain-version-string[`MessageProxyForSchain.version`]]
:xref-MessageProxyForSchain-version-string: xref:#MessageProxyForSchain-version-string
:MessageProxyForSchain-messageInProgress: pass:normal[xref:#MessageProxyForSchain-messageInProgress-bool[`MessageProxyForSchain.messageInProgress`]]
:xref-MessageProxyForSchain-messageInProgress-bool: xref:#MessageProxyForSchain-messageInProgress-bool
:MessageProxyForSchain-registerExtraContract: pass:normal[xref:#MessageProxyForSchain-registerExtraContract-string-address-[`MessageProxyForSchain.registerExtraContract`]]
:xref-MessageProxyForSchain-registerExtraContract-string-address-: xref:#MessageProxyForSchain-registerExtraContract-string-address-
:MessageProxyForSchain-removeExtraContract: pass:normal[xref:#MessageProxyForSchain-removeExtraContract-string-address-[`MessageProxyForSchain.removeExtraContract`]]
:xref-MessageProxyForSchain-removeExtraContract-string-address-: xref:#MessageProxyForSchain-removeExtraContract-string-address-
:MessageProxyForSchain-addConnectedChain: pass:normal[xref:#MessageProxyForSchain-addConnectedChain-string-[`MessageProxyForSchain.addConnectedChain`]]
:xref-MessageProxyForSchain-addConnectedChain-string-: xref:#MessageProxyForSchain-addConnectedChain-string-
:MessageProxyForSchain-postIncomingMessages: pass:normal[xref:#MessageProxyForSchain-postIncomingMessages-string-uint256-struct-IMessageProxy-Message---struct-IMessageProxy-Signature-[`MessageProxyForSchain.postIncomingMessages`]]
:xref-MessageProxyForSchain-postIncomingMessages-string-uint256-struct-IMessageProxy-Message---struct-IMessageProxy-Signature-: xref:#MessageProxyForSchain-postIncomingMessages-string-uint256-struct-IMessageProxy-Message---struct-IMessageProxy-Signature-
:MessageProxyForSchain-setVersion: pass:normal[xref:#MessageProxyForSchain-setVersion-string-[`MessageProxyForSchain.setVersion`]]
:xref-MessageProxyForSchain-setVersion-string-: xref:#MessageProxyForSchain-setVersion-string-
:MessageProxyForSchain-verifyOutgoingMessageData: pass:normal[xref:#MessageProxyForSchain-verifyOutgoingMessageData-struct-IMessageProxyForSchain-OutgoingMessageData-[`MessageProxyForSchain.verifyOutgoingMessageData`]]
:xref-MessageProxyForSchain-verifyOutgoingMessageData-struct-IMessageProxyForSchain-OutgoingMessageData-: xref:#MessageProxyForSchain-verifyOutgoingMessageData-struct-IMessageProxyForSchain-OutgoingMessageData-
:MessageProxyForSchain-verifySignature: pass:normal[xref:#MessageProxyForSchain-verifySignature-bytes32-struct-IMessageProxy-Signature-[`MessageProxyForSchain.verifySignature`]]
:xref-MessageProxyForSchain-verifySignature-bytes32-struct-IMessageProxy-Signature-: xref:#MessageProxyForSchain-verifySignature-bytes32-struct-IMessageProxy-Signature-
:MessageProxyForSchain-initialize: pass:normal[xref:#MessageProxyForSchain-initialize-contract-IKeyStorage-string-[`MessageProxyForSchain.initialize`]]
:xref-MessageProxyForSchain-initialize-contract-IKeyStorage-string-: xref:#MessageProxyForSchain-initialize-contract-IKeyStorage-string-
:MessageProxyForSchain-removeConnectedChain: pass:normal[xref:#MessageProxyForSchain-removeConnectedChain-string-[`MessageProxyForSchain.removeConnectedChain`]]
:xref-MessageProxyForSchain-removeConnectedChain-string-: xref:#MessageProxyForSchain-removeConnectedChain-string-
:MessageProxyForSchain-postOutgoingMessage: pass:normal[xref:#MessageProxyForSchain-postOutgoingMessage-bytes32-address-bytes-[`MessageProxyForSchain.postOutgoingMessage`]]
:xref-MessageProxyForSchain-postOutgoingMessage-bytes32-address-bytes-: xref:#MessageProxyForSchain-postOutgoingMessage-bytes32-address-bytes-
:MessageProxyForSchain-_verifyMessages: pass:normal[xref:#MessageProxyForSchain-_verifyMessages-bytes32-struct-IMessageProxy-Signature-[`MessageProxyForSchain._verifyMessages`]]
:xref-MessageProxyForSchain-_verifyMessages-bytes32-struct-IMessageProxy-Signature-: xref:#MessageProxyForSchain-_verifyMessages-bytes32-struct-IMessageProxy-Signature-
:MessageProxyForSchain-_getRegistryContracts: pass:normal[xref:#MessageProxyForSchain-_getRegistryContracts--[`MessageProxyForSchain._getRegistryContracts`]]
:xref-MessageProxyForSchain-_getRegistryContracts--: xref:#MessageProxyForSchain-_getRegistryContracts--
:MessageProxyForSchain-_getEtherbase: pass:normal[xref:#MessageProxyForSchain-_getEtherbase--[`MessageProxyForSchain._getEtherbase`]]
:xref-MessageProxyForSchain-_getEtherbase--: xref:#MessageProxyForSchain-_getEtherbase--
...
:MessageProxyForSchain: pass:normal[xref:#MessageProxyForSchain[`++MessageProxyForSchain++`]]
:messageInProgressLocker: pass:normal[xref:#MessageProxyForSchain-messageInProgressLocker--[`++messageInProgressLocker++`]]
:ETHERBASE: pass:normal[xref:#MessageProxyForSchain-ETHERBASE-contract-IEtherbaseUpgradeable[`++ETHERBASE++`]]
:MINIMUM_BALANCE: pass:normal[xref:#MessageProxyForSchain-MINIMUM_BALANCE-uint256[`++MINIMUM_BALANCE++`]]
:keyStorage: pass:normal[xref:#MessageProxyForSchain-keyStorage-contract-IKeyStorage[`++keyStorage++`]]
:schainHash: pass:normal[xref:#MessageProxyForSchain-schainHash-bytes32[`++schainHash++`]]
:version: pass:normal[xref:#MessageProxyForSchain-version-string[`++version++`]]
:messageInProgress: pass:normal[xref:#MessageProxyForSchain-messageInProgress-bool[`++messageInProgress++`]]
:registerExtraContract: pass:normal[xref:#MessageProxyForSchain-registerExtraContract-string-address-[`++registerExtraContract++`]]
:removeExtraContract: pass:normal[xref:#MessageProxyForSchain-removeExtraContract-string-address-[`++removeExtraContract++`]]
:addConnectedChain: pass:normal[xref:#MessageProxyForSchain-addConnectedChain-string-[`++addConnectedChain++`]]
:postIncomingMessages: pass:normal[xref:#MessageProxyForSchain-postIncomingMessages-string-uint256-struct-IMessageProxy-Message---struct-IMessageProxy-Signature-[`++postIncomingMessages++`]]
:setVersion: pass:normal[xref:#MessageProxyForSchain-setVersion-string-[`++setVersion++`]]
:verifyOutgoingMessageData: pass:normal[xref:#MessageProxyForSchain-verifyOutgoingMessageData-struct-IMessageProxyForSchain-OutgoingMessageData-[`++verifyOutgoingMessageData++`]]
:verifySignature: pass:normal[xref:#MessageProxyForSchain-verifySignature-bytes32-struct-IMessageProxy-Signature-[`++verifySignature++`]]
:initialize: pass:normal[xref:#MessageProxyForSchain-initialize-contract-IKeyStorage-string-[`++initialize++`]]
:removeConnectedChain: pass:normal[xref:#MessageProxyForSchain-removeConnectedChain-string-[`++removeConnectedChain++`]]
:postOutgoingMessage: pass:normal[xref:#MessageProxyForSchain-postOutgoingMessage-bytes32-address-bytes-[`++postOutgoingMessage++`]]
:_verifyMessages: pass:normal[xref:#MessageProxyForSchain-_verifyMessages-bytes32-struct-IMessageProxy-Signature-[`++_verifyMessages++`]]
:_getRegistryContracts: pass:normal[xref:#MessageProxyForSchain-_getRegistryContracts--[`++_getRegistryContracts++`]]
:_getEtherbase: pass:normal[xref:#MessageProxyForSchain-_getEtherbase--[`++_getEtherbase++`]]

[.contract]
[[MessageProxyForSchain]]
= MessageProxyForSchain

Entry point for messages that come from mainnet or other SKALE chains
...
.Modifiers
--
* {xref-MessageProxyForSchain-messageInProgressLocker--}[`++messageInProgressLocker()++`]
--

[.contract-index]
.Functions
--
* {xref-MessageProxyForSchain-registerExtraContract-string-address-}[`++registerExtraContract(chainName, extraContract)++`]
* {xref-MessageProxyForSchain-removeExtraContract-string-address-}[`++removeExtraContract(chainName, extraContract)++`]
* {xref-MessageProxyForSchain-addConnectedChain-string-}[`++addConnectedChain(chainName)++`]
* {xref-MessageProxyForSchain-postIncomingMessages-string-uint256-struct-IMessageProxy-Message---struct-IMessageProxy-Signature-}[`++postIncomingMessages(fromChainName, startingCounter, messages, signature)++`]
* {xref-MessageProxyForSchain-setVersion-string-}[`++setVersion(newVersion)++`]
* {xref-MessageProxyForSchain-verifyOutgoingMessageData-struct-IMessageProxyForSchain-OutgoingMessageData-}[`++verifyOutgoingMessageData(message)++`]
* {xref-MessageProxyForSchain-verifySignature-bytes32-struct-IMessageProxy-Signature-}[`++verifySignature(hashedMessage, signature)++`]
* {xref-MessageProxyForSchain-initialize-contract-IKeyStorage-string-}[`++initialize(blsKeyStorage, schainName)++`]
* {xref-MessageProxyForSchain-removeConnectedChain-string-}[`++removeConnectedChain(chainName)++`]
* {xref-MessageProxyForSchain-postOutgoingMessage-bytes32-address-bytes-}[`++postOutgoingMessage(targetChainHash, targetContract, data)++`]
* {xref-MessageProxyForSchain-_verifyMessages-bytes32-struct-IMessageProxy-Signature-}[`++_verifyMessages(hashedMessages, signature)++`]
* {xref-MessageProxyForSchain-_getRegistryContracts--}[`++_getRegistryContracts()++`]
* {xref-MessageProxyForSchain-_getEtherbase--}[`++_getEtherbase()++`]
--
...
[.contract-item]
[[MessageProxyForSchain-messageInProgressLocker--]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-messageInProgressLocker-->messageInProgressLocker</a>+++ `++messageInProgressLocker()++` [.item-kind]#modifier#

Reentrancy guard for postIncomingMessages.


[.contract-item]
[[MessageProxyForSchain-registerExtraContract-string-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-registerExtraContract-string-address->registerExtraContract</a>+++ `++registerExtraContract(++[.var-type]#++string++#++ ++[.var-name]#++chainName++#++, ++[.var-type]#++address++#++ ++[.var-name]#++extraContract++#++)++` [.item-kind]#external#
...
[.contract-item]
[[MessageProxyForSchain-removeExtraContract-string-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-removeExtraContract-string-address->removeExtraContract</a>+++ `++removeExtraContract(++[.var-type]#++string++#++ ++[.var-name]#++chainName++#++, ++[.var-type]#++address++#++ ++[.var-name]#++extraContract++#++)++` [.item-kind]#external#
...
[.contract-item]
[[MessageProxyForSchain-addConnectedChain-string-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-addConnectedChain-string->addConnectedChain</a>+++ `++addConnectedChain(++[.var-type]#++string++#++ ++[.var-name]#++chainName++#++)++` [.item-kind]#external#
...
[.contract-item]
[[MessageProxyForSchain-postIncomingMessages-string-uint256-struct-IMessageProxy-Message---struct-IMessageProxy-Signature-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-postIncomingMessages-string-uint256-struct-IMessageProxy-Message---struct-IMessageProxy-Signature->postIncomingMessages</a>+++ `++postIncomingMessages(++[.var-type]#++string++#++ ++[.var-name]#++fromChainName++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++startingCounter++#++, ++[.var-type]#++struct IMessageProxy.Message[]++#++ ++[.var-name]#++messages++#++, ++[.var-type]#++struct IMessageProxy.Signature++#++ ++[.var-name]#++signature++#++)++` [.item-kind]#external#
...
[.contract-item]
[[MessageProxyForSchain-setVersion-string-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-setVersion-string->setVersion</a>+++ `++setVersion(++[.var-type]#++string++#++ ++[.var-name]#++newVersion++#++)++` [.item-kind]#external#

Sets new version of contracts on schain
...
[.contract-item]
[[MessageProxyForSchain-verifyOutgoingMessageData-struct-IMessageProxyForSchain-OutgoingMessageData-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-verifyOutgoingMessageData-struct-IMessageProxyForSchain-OutgoingMessageData->verifyOutgoingMessageData</a>+++ `++verifyOutgoingMessageData(++[.var-type]#++struct IMessageProxyForSchain.OutgoingMessageData++#++ ++[.var-name]#++message++#++) → ++[.var-type]#++bool++#++ ++[.var-name]#++isValidMessage++#++++` [.item-kind]#external#

Verify if the message metadata is valid.

[.contract-item]
[[MessageProxyForSchain-verifySignature-bytes32-struct-IMessageProxy-Signature-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-verifySignature-bytes32-struct-IMessageProxy-Signature->verifySignature</a>+++ `++verifySignature(++[.var-type]#++bytes32++#++ ++[.var-name]#++hashedMessage++#++, ++[.var-type]#++struct IMessageProxy.Signature++#++ ++[.var-name]#++signature++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Verify signature of hashed message

[.contract-item]
[[MessageProxyForSchain-initialize-contract-IKeyStorage-string-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-initialize-contract-IKeyStorage-string->initialize</a>+++ `++initialize(++[.var-type]#++contract IKeyStorage++#++ ++[.var-name]#++blsKeyStorage++#++, ++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++)++` [.item-kind]#public#

Is called once during contract deployment.

[.contract-item]
[[MessageProxyForSchain-removeConnectedChain-string-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-removeConnectedChain-string->removeConnectedChain</a>+++ `++removeConnectedChain(++[.var-type]#++string++#++ ++[.var-name]#++chainName++#++)++` [.item-kind]#public#
...
[.contract-item]
[[MessageProxyForSchain-postOutgoingMessage-bytes32-address-bytes-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-postOutgoingMessage-bytes32-address-bytes->postOutgoingMessage</a>+++ `++postOutgoingMessage(++[.var-type]#++bytes32++#++ ++[.var-name]#++targetChainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++targetContract++#++, ++[.var-type]#++bytes++#++ ++[.var-name]#++data++#++)++` [.item-kind]#public#

This function is called by a smart contract
...
[.contract-item]
[[MessageProxyForSchain-_verifyMessages-bytes32-struct-IMessageProxy-Signature-]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-_verifyMessages-bytes32-struct-IMessageProxy-Signature->_verifyMessages</a>+++ `++_verifyMessages(++[.var-type]#++bytes32++#++ ++[.var-name]#++hashedMessages++#++, ++[.var-type]#++struct IMessageProxy.Signature++#++ ++[.var-name]#++signature++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#internal#
...
[.contract-item]
[[MessageProxyForSchain-_getRegistryContracts--]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-_getRegistryContracts-->_getRegistryContracts</a>+++ `++_getRegistryContracts() → ++[.var-type]#++mapping(bytes32 => struct EnumerableSetUpgradeable.AddressSet)++#++++` [.item-kind]#internal#

Returns list of registered custom extra contracts.

[.contract-item]
[[MessageProxyForSchain-_getEtherbase--]]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-_getEtherbase-->_getEtherbase</a>+++ `++_getEtherbase() → ++[.var-type]#++contract IEtherbaseUpgradeable++#++++` [.item-kind]#internal#

Returns Etherbase contract
