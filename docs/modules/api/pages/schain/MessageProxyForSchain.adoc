...
:keyStorage: pass:normal[xref:#MessageProxyForSchain-keyStorage-contract-KeyStorage[`++keyStorage++`]]
...
:initialize: pass:normal[xref:#MessageProxyForSchain-initialize-contract-KeyStorage-string-[`++initialize++`]]
...
:postIncomingMessages: pass:normal[xref:#MessageProxyForSchain-postIncomingMessages-string-uint256-struct-MessageProxy-Message---struct-MessageProxy-Signature-[`++postIncomingMessages++`]]
:verifyOutgoingMessageData: pass:normal[xref:#MessageProxyForSchain-verifyOutgoingMessageData-struct-MessageProxyForSchain-OutgoingMessageData-[`++verifyOutgoingMessageData++`]]
:_verifyMessages: pass:normal[xref:#MessageProxyForSchain-_verifyMessages-bytes32-struct-MessageProxy-Signature-[`++_verifyMessages++`]]
...
* {xref-MessageProxyForSchain-initialize-contract-KeyStorage-string-}[`++initialize(blsKeyStorage, schainName)++`]
...
* {xref-MessageProxyForSchain-postIncomingMessages-string-uint256-struct-MessageProxy-Message---struct-MessageProxy-Signature-}[`++postIncomingMessages(fromChainName, startingCounter, messages, signature)++`]
* {xref-MessageProxyForSchain-verifyOutgoingMessageData-struct-MessageProxyForSchain-OutgoingMessageData-}[`++verifyOutgoingMessageData(message)++`]
* {xref-MessageProxyForSchain-_verifyMessages-bytes32-struct-MessageProxy-Signature-}[`++_verifyMessages(hashedMessages, signature)++`]
--
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-initialize-contract-KeyStorage-string->initialize</a>+++ `++initialize(++[.var-type]#++contract KeyStorage++#++ ++[.var-name]#++blsKeyStorage++#++, ++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++)++` [.item-kind]#public#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-postIncomingMessages-string-uint256-struct-MessageProxy-Message---struct-MessageProxy-Signature->postIncomingMessages</a>+++ `++postIncomingMessages(++[.var-type]#++string++#++ ++[.var-name]#++fromChainName++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++startingCounter++#++, ++[.var-type]#++struct MessageProxy.Message[]++#++ ++[.var-name]#++messages++#++, ++[.var-type]#++struct MessageProxy.Signature++#++ ++[.var-name]#++signature++#++)++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-verifyOutgoingMessageData-struct-MessageProxyForSchain-OutgoingMessageData->verifyOutgoingMessageData</a>+++ `++verifyOutgoingMessageData(++[.var-type]#++struct MessageProxyForSchain.OutgoingMessageData++#++ ++[.var-name]#++message++#++) → ++[.var-type]#++bool++#++ ++[.var-name]#++isValidMessage++#++++` [.item-kind]#external#

Verify if the message metadata is valid.

[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForSchain-_verifyMessages-bytes32-struct-MessageProxy-Signature->_verifyMessages</a>+++ `++_verifyMessages(++[.var-type]#++bytes32++#++ ++[.var-name]#++hashedMessages++#++, ++[.var-type]#++struct MessageProxy.Signature++#++ ++[.var-name]#++signature++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#internal#
