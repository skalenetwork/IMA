...
:messageProxy: pass:normal[xref:#TokenManager-messageProxy-contract-MessageProxyForSchain[`++messageProxy++`]]
:tokenManagerLinker: pass:normal[xref:#TokenManager-tokenManagerLinker-contract-TokenManagerLinker[`++tokenManagerLinker++`]]
:communityLocker: pass:normal[xref:#TokenManager-communityLocker-contract-CommunityLocker[`++communityLocker++`]]
...
:initializeTokenManager: pass:normal[xref:#TokenManager-initializeTokenManager-string-contract-MessageProxyForSchain-contract-TokenManagerLinker-contract-CommunityLocker-address-[`++initializeTokenManager++`]]
...
* {xref-TokenManager-initializeTokenManager-string-contract-MessageProxyForSchain-contract-TokenManagerLinker-contract-CommunityLocker-address-}[`++initializeTokenManager(newSchainName, newMessageProxy, newIMALinker, newCommunityLocker, newDepositBox)++`]
--
...
Adds a TokenManagerEth address to
depositBox.
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManager-initializeTokenManager-string-contract-MessageProxyForSchain-contract-TokenManagerLinker-contract-CommunityLocker-address->initializeTokenManager</a>+++ `++initializeTokenManager(++[.var-type]#++string++#++ ++[.var-name]#++newSchainName++#++, ++[.var-type]#++contract MessageProxyForSchain++#++ ++[.var-name]#++newMessageProxy++#++, ++[.var-type]#++contract TokenManagerLinker++#++ ++[.var-name]#++newIMALinker++#++, ++[.var-type]#++contract CommunityLocker++#++ ++[.var-name]#++newCommunityLocker++#++, ++[.var-type]#++address++#++ ++[.var-name]#++newDepositBox++#++)++` [.item-kind]#public#
