...
:TokenManager: pass:normal[xref:#TokenManager[`TokenManager`]]
:xref-TokenManager: xref:#TokenManager
:TokenManager-onlyAutomaticDeploy: pass:normal[xref:#TokenManager-onlyAutomaticDeploy--[`TokenManager.onlyAutomaticDeploy`]]
:xref-TokenManager-onlyAutomaticDeploy--: xref:#TokenManager-onlyAutomaticDeploy--
:TokenManager-onlyTokenRegistrar: pass:normal[xref:#TokenManager-onlyTokenRegistrar--[`TokenManager.onlyTokenRegistrar`]]
:xref-TokenManager-onlyTokenRegistrar--: xref:#TokenManager-onlyTokenRegistrar--
:TokenManager-onlyMessageProxy: pass:normal[xref:#TokenManager-onlyMessageProxy--[`TokenManager.onlyMessageProxy`]]
:xref-TokenManager-onlyMessageProxy--: xref:#TokenManager-onlyMessageProxy--
:TokenManager-rightTransaction: pass:normal[xref:#TokenManager-rightTransaction-string-address-[`TokenManager.rightTransaction`]]
:xref-TokenManager-rightTransaction-string-address-: xref:#TokenManager-rightTransaction-string-address-
:TokenManager-checkReceiverChain: pass:normal[xref:#TokenManager-checkReceiverChain-bytes32-address-[`TokenManager.checkReceiverChain`]]
:xref-TokenManager-checkReceiverChain-bytes32-address-: xref:#TokenManager-checkReceiverChain-bytes32-address-
:TokenManager-MAINNET_NAME: pass:normal[xref:#TokenManager-MAINNET_NAME-string[`TokenManager.MAINNET_NAME`]]
:xref-TokenManager-MAINNET_NAME-string: xref:#TokenManager-MAINNET_NAME-string
:TokenManager-MAINNET_HASH: pass:normal[xref:#TokenManager-MAINNET_HASH-bytes32[`TokenManager.MAINNET_HASH`]]
:xref-TokenManager-MAINNET_HASH-bytes32: xref:#TokenManager-MAINNET_HASH-bytes32
:TokenManager-AUTOMATIC_DEPLOY_ROLE: pass:normal[xref:#TokenManager-AUTOMATIC_DEPLOY_ROLE-bytes32[`TokenManager.AUTOMATIC_DEPLOY_ROLE`]]
:xref-TokenManager-AUTOMATIC_DEPLOY_ROLE-bytes32: xref:#TokenManager-AUTOMATIC_DEPLOY_ROLE-bytes32
:TokenManager-TOKEN_REGISTRAR_ROLE: pass:normal[xref:#TokenManager-TOKEN_REGISTRAR_ROLE-bytes32[`TokenManager.TOKEN_REGISTRAR_ROLE`]]
:xref-TokenManager-TOKEN_REGISTRAR_ROLE-bytes32: xref:#TokenManager-TOKEN_REGISTRAR_ROLE-bytes32
:TokenManager-messageProxy: pass:normal[xref:#TokenManager-messageProxy-contract-IMessageProxyForSchain[`TokenManager.messageProxy`]]
:xref-TokenManager-messageProxy-contract-IMessageProxyForSchain: xref:#TokenManager-messageProxy-contract-IMessageProxyForSchain
:TokenManager-tokenManagerLinker: pass:normal[xref:#TokenManager-tokenManagerLinker-contract-ITokenManagerLinker[`TokenManager.tokenManagerLinker`]]
:xref-TokenManager-tokenManagerLinker-contract-ITokenManagerLinker: xref:#TokenManager-tokenManagerLinker-contract-ITokenManagerLinker
:TokenManager-communityLocker: pass:normal[xref:#TokenManager-communityLocker-contract-ICommunityLocker[`TokenManager.communityLocker`]]
:xref-TokenManager-communityLocker-contract-ICommunityLocker: xref:#TokenManager-communityLocker-contract-ICommunityLocker
:TokenManager-schainHash: pass:normal[xref:#TokenManager-schainHash-bytes32[`TokenManager.schainHash`]]
:xref-TokenManager-schainHash-bytes32: xref:#TokenManager-schainHash-bytes32
:TokenManager-depositBox: pass:normal[xref:#TokenManager-depositBox-address[`TokenManager.depositBox`]]
:xref-TokenManager-depositBox-address: xref:#TokenManager-depositBox-address
:TokenManager-automaticDeploy: pass:normal[xref:#TokenManager-automaticDeploy-bool[`TokenManager.automaticDeploy`]]
:xref-TokenManager-automaticDeploy-bool: xref:#TokenManager-automaticDeploy-bool
:TokenManager-tokenManagers: pass:normal[xref:#TokenManager-tokenManagers-mapping-bytes32----address-[`TokenManager.tokenManagers`]]
:xref-TokenManager-tokenManagers-mapping-bytes32----address-: xref:#TokenManager-tokenManagers-mapping-bytes32----address-
:TokenManager-enableAutomaticDeploy: pass:normal[xref:#TokenManager-enableAutomaticDeploy--[`TokenManager.enableAutomaticDeploy`]]
:xref-TokenManager-enableAutomaticDeploy--: xref:#TokenManager-enableAutomaticDeploy--
:TokenManager-disableAutomaticDeploy: pass:normal[xref:#TokenManager-disableAutomaticDeploy--[`TokenManager.disableAutomaticDeploy`]]
:xref-TokenManager-disableAutomaticDeploy--: xref:#TokenManager-disableAutomaticDeploy--
:TokenManager-addTokenManager: pass:normal[xref:#TokenManager-addTokenManager-string-address-[`TokenManager.addTokenManager`]]
:xref-TokenManager-addTokenManager-string-address-: xref:#TokenManager-addTokenManager-string-address-
:TokenManager-removeTokenManager: pass:normal[xref:#TokenManager-removeTokenManager-string-[`TokenManager.removeTokenManager`]]
:xref-TokenManager-removeTokenManager-string-: xref:#TokenManager-removeTokenManager-string-
:TokenManager-changeDepositBoxAddress: pass:normal[xref:#TokenManager-changeDepositBoxAddress-address-[`TokenManager.changeDepositBoxAddress`]]
:xref-TokenManager-changeDepositBoxAddress-address-: xref:#TokenManager-changeDepositBoxAddress-address-
:TokenManager-hasTokenManager: pass:normal[xref:#TokenManager-hasTokenManager-string-[`TokenManager.hasTokenManager`]]
:xref-TokenManager-hasTokenManager-string-: xref:#TokenManager-hasTokenManager-string-
:TokenManager-initializeTokenManager: pass:normal[xref:#TokenManager-initializeTokenManager-string-contract-IMessageProxyForSchain-contract-ITokenManagerLinker-contract-ICommunityLocker-address-[`TokenManager.initializeTokenManager`]]
:xref-TokenManager-initializeTokenManager-string-contract-IMessageProxyForSchain-contract-ITokenManagerLinker-contract-ICommunityLocker-address-: xref:#TokenManager-initializeTokenManager-string-contract-IMessageProxyForSchain-contract-ITokenManagerLinker-contract-ICommunityLocker-address-
:TokenManager-_checkSender: pass:normal[xref:#TokenManager-_checkSender-bytes32-address-[`TokenManager._checkSender`]]
:xref-TokenManager-_checkSender-bytes32-address-: xref:#TokenManager-_checkSender-bytes32-address-
:TokenManager-DepositBoxWasChanged: pass:normal[xref:#TokenManager-DepositBoxWasChanged-address-address-[`TokenManager.DepositBoxWasChanged`]]
:xref-TokenManager-DepositBoxWasChanged-address-address-: xref:#TokenManager-DepositBoxWasChanged-address-address-
...
:TokenManager: pass:normal[xref:#TokenManager[`++TokenManager++`]]
:onlyAutomaticDeploy: pass:normal[xref:#TokenManager-onlyAutomaticDeploy--[`++onlyAutomaticDeploy++`]]
:onlyTokenRegistrar: pass:normal[xref:#TokenManager-onlyTokenRegistrar--[`++onlyTokenRegistrar++`]]
:onlyMessageProxy: pass:normal[xref:#TokenManager-onlyMessageProxy--[`++onlyMessageProxy++`]]
:rightTransaction: pass:normal[xref:#TokenManager-rightTransaction-string-address-[`++rightTransaction++`]]
:checkReceiverChain: pass:normal[xref:#TokenManager-checkReceiverChain-bytes32-address-[`++checkReceiverChain++`]]
:MAINNET_NAME: pass:normal[xref:#TokenManager-MAINNET_NAME-string[`++MAINNET_NAME++`]]
:MAINNET_HASH: pass:normal[xref:#TokenManager-MAINNET_HASH-bytes32[`++MAINNET_HASH++`]]
:AUTOMATIC_DEPLOY_ROLE: pass:normal[xref:#TokenManager-AUTOMATIC_DEPLOY_ROLE-bytes32[`++AUTOMATIC_DEPLOY_ROLE++`]]
:TOKEN_REGISTRAR_ROLE: pass:normal[xref:#TokenManager-TOKEN_REGISTRAR_ROLE-bytes32[`++TOKEN_REGISTRAR_ROLE++`]]
:messageProxy: pass:normal[xref:#TokenManager-messageProxy-contract-IMessageProxyForSchain[`++messageProxy++`]]
:tokenManagerLinker: pass:normal[xref:#TokenManager-tokenManagerLinker-contract-ITokenManagerLinker[`++tokenManagerLinker++`]]
:communityLocker: pass:normal[xref:#TokenManager-communityLocker-contract-ICommunityLocker[`++communityLocker++`]]
:schainHash: pass:normal[xref:#TokenManager-schainHash-bytes32[`++schainHash++`]]
:depositBox: pass:normal[xref:#TokenManager-depositBox-address[`++depositBox++`]]
:automaticDeploy: pass:normal[xref:#TokenManager-automaticDeploy-bool[`++automaticDeploy++`]]
:tokenManagers: pass:normal[xref:#TokenManager-tokenManagers-mapping-bytes32----address-[`++tokenManagers++`]]
:enableAutomaticDeploy: pass:normal[xref:#TokenManager-enableAutomaticDeploy--[`++enableAutomaticDeploy++`]]
:disableAutomaticDeploy: pass:normal[xref:#TokenManager-disableAutomaticDeploy--[`++disableAutomaticDeploy++`]]
:addTokenManager: pass:normal[xref:#TokenManager-addTokenManager-string-address-[`++addTokenManager++`]]
:removeTokenManager: pass:normal[xref:#TokenManager-removeTokenManager-string-[`++removeTokenManager++`]]
:changeDepositBoxAddress: pass:normal[xref:#TokenManager-changeDepositBoxAddress-address-[`++changeDepositBoxAddress++`]]
:hasTokenManager: pass:normal[xref:#TokenManager-hasTokenManager-string-[`++hasTokenManager++`]]
:initializeTokenManager: pass:normal[xref:#TokenManager-initializeTokenManager-string-contract-IMessageProxyForSchain-contract-ITokenManagerLinker-contract-ICommunityLocker-address-[`++initializeTokenManager++`]]
:_checkSender: pass:normal[xref:#TokenManager-_checkSender-bytes32-address-[`++_checkSender++`]]
:DepositBoxWasChanged: pass:normal[xref:#TokenManager-DepositBoxWasChanged-address-address-[`++DepositBoxWasChanged++`]]
...
.Modifiers
--
* {xref-TokenManager-onlyAutomaticDeploy--}[`++onlyAutomaticDeploy()++`]
* {xref-TokenManager-onlyTokenRegistrar--}[`++onlyTokenRegistrar()++`]
* {xref-TokenManager-onlyMessageProxy--}[`++onlyMessageProxy()++`]
* {xref-TokenManager-rightTransaction-string-address-}[`++rightTransaction(targetSchainName, to)++`]
* {xref-TokenManager-checkReceiverChain-bytes32-address-}[`++checkReceiverChain(fromChainHash, sender)++`]
--

[.contract-index]
.Functions
--
* {xref-TokenManager-enableAutomaticDeploy--}[`++enableAutomaticDeploy()++`]
* {xref-TokenManager-disableAutomaticDeploy--}[`++disableAutomaticDeploy()++`]
* {xref-TokenManager-addTokenManager-string-address-}[`++addTokenManager(schainName, newTokenManager)++`]
* {xref-TokenManager-removeTokenManager-string-}[`++removeTokenManager(schainName)++`]
* {xref-TokenManager-changeDepositBoxAddress-address-}[`++changeDepositBoxAddress(newDepositBox)++`]
* {xref-TokenManager-hasTokenManager-string-}[`++hasTokenManager(schainName)++`]
* {xref-TokenManager-initializeTokenManager-string-contract-IMessageProxyForSchain-contract-ITokenManagerLinker-contract-ICommunityLocker-address-}[`++initializeTokenManager(newSchainName, newMessageProxy, newIMALinker, newCommunityLocker, newDepositBox)++`]
* {xref-TokenManager-_checkSender-bytes32-address-}[`++_checkSender(fromChainHash, sender)++`]
--

[.contract-index]
.Events
--
* {xref-TokenManager-DepositBoxWasChanged-address-address-}[`++DepositBoxWasChanged(oldValue, newValue)++`]
--

[.contract-item]
[[TokenManager-onlyAutomaticDeploy--]]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManager-onlyAutomaticDeploy-->onlyAutomaticDeploy</a>+++ `++onlyAutomaticDeploy()++` [.item-kind]#modifier#

Modifier to make a function callable only if caller is granted with {AUTOMATIC_DEPLOY_ROLE}.

[.contract-item]
[[TokenManager-onlyTokenRegistrar--]]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManager-onlyTokenRegistrar-->onlyTokenRegistrar</a>+++ `++onlyTokenRegistrar()++` [.item-kind]#modifier#

Modifier to make a function callable only if caller is granted with {TOKEN_REGISTRAR_ROLE}.

[.contract-item]
[[TokenManager-onlyMessageProxy--]]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManager-onlyMessageProxy-->onlyMessageProxy</a>+++ `++onlyMessageProxy()++` [.item-kind]#modifier#

Modifier to make a function callable only if caller is {MessageProxy}.

[.contract-item]
[[TokenManager-rightTransaction-string-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManager-rightTransaction-string-address->rightTransaction</a>+++ `++rightTransaction(++[.var-type]#++string++#++ ++[.var-name]#++targetSchainName++#++, ++[.var-type]#++address++#++ ++[.var-name]#++to++#++)++` [.item-kind]#modifier#

Modifier to make a function callable only if
a message does not aim mainnet, target SKALE chain has token manager and receiver is set.

[.contract-item]
[[TokenManager-checkReceiverChain-bytes32-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManager-checkReceiverChain-bytes32-address->checkReceiverChain</a>+++ `++checkReceiverChain(++[.var-type]#++bytes32++#++ ++[.var-name]#++fromChainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++sender++#++)++` [.item-kind]#modifier#
...
[.contract-item]
[[TokenManager-enableAutomaticDeploy--]]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManager-enableAutomaticDeploy-->enableAutomaticDeploy</a>+++ `++enableAutomaticDeploy()++` [.item-kind]#external#
...
[.contract-item]
[[TokenManager-disableAutomaticDeploy--]]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManager-disableAutomaticDeploy-->disableAutomaticDeploy</a>+++ `++disableAutomaticDeploy()++` [.item-kind]#external#
...
[.contract-item]
[[TokenManager-addTokenManager-string-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManager-addTokenManager-string-address->addTokenManager</a>+++ `++addTokenManager(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++, ++[.var-type]#++address++#++ ++[.var-name]#++newTokenManager++#++)++` [.item-kind]#external#

Adds a TokenManager on SKALE chain to this TokenManager.
...
[.contract-item]
[[TokenManager-removeTokenManager-string-]]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManager-removeTokenManager-string->removeTokenManager</a>+++ `++removeTokenManager(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++)++` [.item-kind]#external#
...
[.contract-item]
[[TokenManager-changeDepositBoxAddress-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManager-changeDepositBoxAddress-address->changeDepositBoxAddress</a>+++ `++changeDepositBoxAddress(++[.var-type]#++address++#++ ++[.var-name]#++newDepositBox++#++)++` [.item-kind]#external#

Change Deposit Box address
...
[.contract-item]
[[TokenManager-hasTokenManager-string-]]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManager-hasTokenManager-string->hasTokenManager</a>+++ `++hasTokenManager(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether TokenManager is connected to a {schainName} SKALE chain TokenManager.

[.contract-item]
[[TokenManager-initializeTokenManager-string-contract-IMessageProxyForSchain-contract-ITokenManagerLinker-contract-ICommunityLocker-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManager-initializeTokenManager-string-contract-IMessageProxyForSchain-contract-ITokenManagerLinker-contract-ICommunityLocker-address->initializeTokenManager</a>+++ `++initializeTokenManager(++[.var-type]#++string++#++ ++[.var-name]#++newSchainName++#++, ++[.var-type]#++contract IMessageProxyForSchain++#++ ++[.var-name]#++newMessageProxy++#++, ++[.var-type]#++contract ITokenManagerLinker++#++ ++[.var-name]#++newIMALinker++#++, ++[.var-type]#++contract ICommunityLocker++#++ ++[.var-name]#++newCommunityLocker++#++, ++[.var-type]#++address++#++ ++[.var-name]#++newDepositBox++#++)++` [.item-kind]#public#

Is called once during contract deployment.

[.contract-item]
[[TokenManager-_checkSender-bytes32-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManager-_checkSender-bytes32-address->_checkSender</a>+++ `++_checkSender(++[.var-type]#++bytes32++#++ ++[.var-name]#++fromChainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++sender++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#internal#

Checks whether sender contract is DepositBox or TokenManager depending on chainHash.


[.contract-item]
[[TokenManager-DepositBoxWasChanged-address-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=TokenManager-DepositBoxWasChanged-address-address->DepositBoxWasChanged</a>+++ `++DepositBoxWasChanged(++[.var-type]#++address++#++ ++[.var-name]#++oldValue++#++, ++[.var-type]#++address++#++ ++[.var-name]#++newValue++#++)++` [.item-kind]#event#
