...
:Linker: pass:normal[xref:#Linker[`++Linker++`]]
:onlyLinker: pass:normal[xref:#Linker-onlyLinker--[`++onlyLinker++`]]
:statuses: pass:normal[xref:#Linker-statuses-mapping-bytes32----enum-Linker-KillProcess-[`++statuses++`]]
:registerMainnetContract: pass:normal[xref:#Linker-registerMainnetContract-address-[`++registerMainnetContract++`]]
:removeMainnetContract: pass:normal[xref:#Linker-removeMainnetContract-address-[`++removeMainnetContract++`]]
:connectSchain: pass:normal[xref:#Linker-connectSchain-string-address---[`++connectSchain++`]]
:kill: pass:normal[xref:#Linker-kill-string-[`++kill++`]]
:disconnectSchain: pass:normal[xref:#Linker-disconnectSchain-string-[`++disconnectSchain++`]]
:isNotKilled: pass:normal[xref:#Linker-isNotKilled-bytes32-[`++isNotKilled++`]]
:hasMainnetContract: pass:normal[xref:#Linker-hasMainnetContract-address-[`++hasMainnetContract++`]]
:hasSchain: pass:normal[xref:#Linker-hasSchain-string-[`++hasSchain++`]]
:initialize: pass:normal[xref:#Linker-initialize-contract-IContractManager-contract-IMessageProxyForMainnet-[`++initialize++`]]
...
.Modifiers
--
* {xref-Linker-onlyLinker--}[`++onlyLinker()++`]
--

[.contract-index]
.Functions
--
* {xref-Linker-registerMainnetContract-address-}[`++registerMainnetContract(newMainnetContract)++`]
* {xref-Linker-removeMainnetContract-address-}[`++removeMainnetContract(mainnetContract)++`]
* {xref-Linker-connectSchain-string-address---}[`++connectSchain(schainName, schainContracts)++`]
* {xref-Linker-kill-string-}[`++kill(schainName)++`]
* {xref-Linker-disconnectSchain-string-}[`++disconnectSchain(schainName)++`]
* {xref-Linker-isNotKilled-bytes32-}[`++isNotKilled(schainHash)++`]
* {xref-Linker-hasMainnetContract-address-}[`++hasMainnetContract(mainnetContract)++`]
* {xref-Linker-hasSchain-string-}[`++hasSchain(schainName)++`]
* {xref-Linker-initialize-contract-IContractManager-contract-IMessageProxyForMainnet-}[`++initialize(contractManagerOfSkaleManagerValue, messageProxyValue)++`]
--
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=Linker-onlyLinker-->onlyLinker</a>+++ `++onlyLinker()++` [.item-kind]#modifier#

Modifier to make a function callable only if caller is granted with {LINKER_ROLE}.


[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=Linker-registerMainnetContract-address->registerMainnetContract</a>+++ `++registerMainnetContract(++[.var-type]#++address++#++ ++[.var-name]#++newMainnetContract++#++)++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=Linker-removeMainnetContract-address->removeMainnetContract</a>+++ `++removeMainnetContract(++[.var-type]#++address++#++ ++[.var-name]#++mainnetContract++#++)++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=Linker-connectSchain-string-address--->connectSchain</a>+++ `++connectSchain(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++, ++[.var-type]#++address[]++#++ ++[.var-name]#++schainContracts++#++)++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=Linker-kill-string->kill</a>+++ `++kill(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++)++` [.item-kind]#external#

Allows Schain owner and contract deployer to kill schain. 
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=Linker-disconnectSchain-string->disconnectSchain</a>+++ `++disconnectSchain(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++)++` [.item-kind]#external#

Allows Linker disconnect schain from the network. This will remove all receiver contracts on schain.
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=Linker-isNotKilled-bytes32->isNotKilled</a>+++ `++isNotKilled(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Returns true if schain is not killed.

[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=Linker-hasMainnetContract-address->hasMainnetContract</a>+++ `++hasMainnetContract(++[.var-type]#++address++#++ ++[.var-name]#++mainnetContract++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Returns true if list of mainnet contracts has particular contract.

[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=Linker-hasSchain-string->hasSchain</a>+++ `++hasSchain(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++) → ++[.var-type]#++bool++#++ ++[.var-name]#++connected++#++++` [.item-kind]#external#

Returns true if mainnet contracts and schain contracts are connected together for transferring messages.

[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=Linker-initialize-contract-IContractManager-contract-IMessageProxyForMainnet->initialize</a>+++ `++initialize(++[.var-type]#++contract IContractManager++#++ ++[.var-name]#++contractManagerOfSkaleManagerValue++#++, ++[.var-type]#++contract IMessageProxyForMainnet++#++ ++[.var-name]#++messageProxyValue++#++)++` [.item-kind]#public#
