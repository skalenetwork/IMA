...
:interchainConnections: pass:normal[xref:#Linker-interchainConnections-mapping-bytes32----bool-[`++interchainConnections++`]]
...
:allowInterchainConnections: pass:normal[xref:#Linker-allowInterchainConnections-string-[`++allowInterchainConnections++`]]
...
:initialize: pass:normal[xref:#Linker-initialize-contract-IContractManager-contract-MessageProxyForMainnet-[`++initialize++`]]
...
* {xref-Linker-allowInterchainConnections-string-}[`++allowInterchainConnections(schainName)++`]
...
* {xref-Linker-initialize-contract-IContractManager-contract-MessageProxyForMainnet-}[`++initialize(contractManagerOfSkaleManagerValue, messageProxyValue)++`]
--
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=Linker-allowInterchainConnections-string->allowInterchainConnections</a>+++ `++allowInterchainConnections(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++)++` [.item-kind]#external#

Allows Schain owner to connect others chains with their own,
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=Linker-initialize-contract-IContractManager-contract-MessageProxyForMainnet->initialize</a>+++ `++initialize(++[.var-type]#++contract IContractManager++#++ ++[.var-name]#++contractManagerOfSkaleManagerValue++#++, ++[.var-type]#++contract MessageProxyForMainnet++#++ ++[.var-name]#++messageProxyValue++#++)++` [.item-kind]#public#
