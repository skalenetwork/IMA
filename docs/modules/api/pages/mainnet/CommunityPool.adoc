...
:CommunityPool: pass:normal[xref:#CommunityPool[`CommunityPool`]]
:xref-CommunityPool: xref:#CommunityPool
:CommunityPool-CONSTANT_SETTER_ROLE: pass:normal[xref:#CommunityPool-CONSTANT_SETTER_ROLE-bytes32[`CommunityPool.CONSTANT_SETTER_ROLE`]]
:xref-CommunityPool-CONSTANT_SETTER_ROLE-bytes32: xref:#CommunityPool-CONSTANT_SETTER_ROLE-bytes32
:CommunityPool-activeUsers: pass:normal[xref:#CommunityPool-activeUsers-mapping-address----mapping-bytes32----bool--[`CommunityPool.activeUsers`]]
:xref-CommunityPool-activeUsers-mapping-address----mapping-bytes32----bool--: xref:#CommunityPool-activeUsers-mapping-address----mapping-bytes32----bool--
:CommunityPool-minTransactionGas: pass:normal[xref:#CommunityPool-minTransactionGas-uint256[`CommunityPool.minTransactionGas`]]
:xref-CommunityPool-minTransactionGas-uint256: xref:#CommunityPool-minTransactionGas-uint256
:CommunityPool-multiplierNumerator: pass:normal[xref:#CommunityPool-multiplierNumerator-uint256[`CommunityPool.multiplierNumerator`]]
:xref-CommunityPool-multiplierNumerator-uint256: xref:#CommunityPool-multiplierNumerator-uint256
:CommunityPool-multiplierDivider: pass:normal[xref:#CommunityPool-multiplierDivider-uint256[`CommunityPool.multiplierDivider`]]
:xref-CommunityPool-multiplierDivider-uint256: xref:#CommunityPool-multiplierDivider-uint256
:CommunityPool-initialize: pass:normal[xref:#CommunityPool-initialize-contract-IContractManager-contract-ILinker-contract-IMessageProxyForMainnet-[`CommunityPool.initialize`]]
:xref-CommunityPool-initialize-contract-IContractManager-contract-ILinker-contract-IMessageProxyForMainnet-: xref:#CommunityPool-initialize-contract-IContractManager-contract-ILinker-contract-IMessageProxyForMainnet-
:CommunityPool-refundGasByUser: pass:normal[xref:#CommunityPool-refundGasByUser-bytes32-address-payable-address-uint256-[`CommunityPool.refundGasByUser`]]
:xref-CommunityPool-refundGasByUser-bytes32-address-payable-address-uint256-: xref:#CommunityPool-refundGasByUser-bytes32-address-payable-address-uint256-
:CommunityPool-refundGasBySchainWallet: pass:normal[xref:#CommunityPool-refundGasBySchainWallet-bytes32-address-payable-uint256-[`CommunityPool.refundGasBySchainWallet`]]
:xref-CommunityPool-refundGasBySchainWallet-bytes32-address-payable-uint256-: xref:#CommunityPool-refundGasBySchainWallet-bytes32-address-payable-uint256-
:CommunityPool-rechargeUserWallet: pass:normal[xref:#CommunityPool-rechargeUserWallet-string-address-[`CommunityPool.rechargeUserWallet`]]
:xref-CommunityPool-rechargeUserWallet-string-address-: xref:#CommunityPool-rechargeUserWallet-string-address-
:CommunityPool-withdrawFunds: pass:normal[xref:#CommunityPool-withdrawFunds-string-uint256-[`CommunityPool.withdrawFunds`]]
:xref-CommunityPool-withdrawFunds-string-uint256-: xref:#CommunityPool-withdrawFunds-string-uint256-
:CommunityPool-setMinTransactionGas: pass:normal[xref:#CommunityPool-setMinTransactionGas-uint256-[`CommunityPool.setMinTransactionGas`]]
:xref-CommunityPool-setMinTransactionGas-uint256-: xref:#CommunityPool-setMinTransactionGas-uint256-
:CommunityPool-setMultiplier: pass:normal[xref:#CommunityPool-setMultiplier-uint256-uint256-[`CommunityPool.setMultiplier`]]
:xref-CommunityPool-setMultiplier-uint256-uint256-: xref:#CommunityPool-setMultiplier-uint256-uint256-
:CommunityPool-getBalance: pass:normal[xref:#CommunityPool-getBalance-address-string-[`CommunityPool.getBalance`]]
:xref-CommunityPool-getBalance-address-string-: xref:#CommunityPool-getBalance-address-string-
:CommunityPool-checkUserBalance: pass:normal[xref:#CommunityPool-checkUserBalance-bytes32-address-[`CommunityPool.checkUserBalance`]]
:xref-CommunityPool-checkUserBalance-bytes32-address-: xref:#CommunityPool-checkUserBalance-bytes32-address-
:CommunityPool-getRecommendedRechargeAmount: pass:normal[xref:#CommunityPool-getRecommendedRechargeAmount-bytes32-address-[`CommunityPool.getRecommendedRechargeAmount`]]
:xref-CommunityPool-getRecommendedRechargeAmount-bytes32-address-: xref:#CommunityPool-getRecommendedRechargeAmount-bytes32-address-
:CommunityPool-MinTransactionGasWasChanged: pass:normal[xref:#CommunityPool-MinTransactionGasWasChanged-uint256-uint256-[`CommunityPool.MinTransactionGasWasChanged`]]
:xref-CommunityPool-MinTransactionGasWasChanged-uint256-uint256-: xref:#CommunityPool-MinTransactionGasWasChanged-uint256-uint256-
:CommunityPool-MultiplierWasChanged: pass:normal[xref:#CommunityPool-MultiplierWasChanged-uint256-uint256-uint256-uint256-[`CommunityPool.MultiplierWasChanged`]]
:xref-CommunityPool-MultiplierWasChanged-uint256-uint256-uint256-uint256-: xref:#CommunityPool-MultiplierWasChanged-uint256-uint256-uint256-uint256-
...
:CommunityPool: pass:normal[xref:#CommunityPool[`++CommunityPool++`]]
:CONSTANT_SETTER_ROLE: pass:normal[xref:#CommunityPool-CONSTANT_SETTER_ROLE-bytes32[`++CONSTANT_SETTER_ROLE++`]]
:activeUsers: pass:normal[xref:#CommunityPool-activeUsers-mapping-address----mapping-bytes32----bool--[`++activeUsers++`]]
:minTransactionGas: pass:normal[xref:#CommunityPool-minTransactionGas-uint256[`++minTransactionGas++`]]
:multiplierNumerator: pass:normal[xref:#CommunityPool-multiplierNumerator-uint256[`++multiplierNumerator++`]]
:multiplierDivider: pass:normal[xref:#CommunityPool-multiplierDivider-uint256[`++multiplierDivider++`]]
:initialize: pass:normal[xref:#CommunityPool-initialize-contract-IContractManager-contract-ILinker-contract-IMessageProxyForMainnet-[`++initialize++`]]
:refundGasByUser: pass:normal[xref:#CommunityPool-refundGasByUser-bytes32-address-payable-address-uint256-[`++refundGasByUser++`]]
:refundGasBySchainWallet: pass:normal[xref:#CommunityPool-refundGasBySchainWallet-bytes32-address-payable-uint256-[`++refundGasBySchainWallet++`]]
:rechargeUserWallet: pass:normal[xref:#CommunityPool-rechargeUserWallet-string-address-[`++rechargeUserWallet++`]]
:withdrawFunds: pass:normal[xref:#CommunityPool-withdrawFunds-string-uint256-[`++withdrawFunds++`]]
:setMinTransactionGas: pass:normal[xref:#CommunityPool-setMinTransactionGas-uint256-[`++setMinTransactionGas++`]]
:setMultiplier: pass:normal[xref:#CommunityPool-setMultiplier-uint256-uint256-[`++setMultiplier++`]]
:getBalance: pass:normal[xref:#CommunityPool-getBalance-address-string-[`++getBalance++`]]
:checkUserBalance: pass:normal[xref:#CommunityPool-checkUserBalance-bytes32-address-[`++checkUserBalance++`]]
:getRecommendedRechargeAmount: pass:normal[xref:#CommunityPool-getRecommendedRechargeAmount-bytes32-address-[`++getRecommendedRechargeAmount++`]]
:MinTransactionGasWasChanged: pass:normal[xref:#CommunityPool-MinTransactionGasWasChanged-uint256-uint256-[`++MinTransactionGasWasChanged++`]]
:MultiplierWasChanged: pass:normal[xref:#CommunityPool-MultiplierWasChanged-uint256-uint256-uint256-uint256-[`++MultiplierWasChanged++`]]
...
.Functions
--
* {xref-CommunityPool-initialize-contract-IContractManager-contract-ILinker-contract-IMessageProxyForMainnet-}[`++initialize(contractManagerOfSkaleManagerValue, linker, messageProxyValue)++`]
* {xref-CommunityPool-refundGasByUser-bytes32-address-payable-address-uint256-}[`++refundGasByUser(schainHash, node, user, gas)++`]
* {xref-CommunityPool-refundGasBySchainWallet-bytes32-address-payable-uint256-}[`++refundGasBySchainWallet(schainHash, node, gas)++`]
* {xref-CommunityPool-rechargeUserWallet-string-address-}[`++rechargeUserWallet(schainName, user)++`]
* {xref-CommunityPool-withdrawFunds-string-uint256-}[`++withdrawFunds(schainName, amount)++`]
* {xref-CommunityPool-setMinTransactionGas-uint256-}[`++setMinTransactionGas(newMinTransactionGas)++`]
* {xref-CommunityPool-setMultiplier-uint256-uint256-}[`++setMultiplier(newMultiplierNumerator, newMultiplierDivider)++`]
* {xref-CommunityPool-getBalance-address-string-}[`++getBalance(user, schainName)++`]
* {xref-CommunityPool-checkUserBalance-bytes32-address-}[`++checkUserBalance(schainHash, receiver)++`]
* {xref-CommunityPool-getRecommendedRechargeAmount-bytes32-address-}[`++getRecommendedRechargeAmount(schainHash, receiver)++`]
--

[.contract-index]
.Events
--
* {xref-CommunityPool-MinTransactionGasWasChanged-uint256-uint256-}[`++MinTransactionGasWasChanged(oldValue, newValue)++`]
* {xref-CommunityPool-MultiplierWasChanged-uint256-uint256-uint256-uint256-}[`++MultiplierWasChanged(oldMultiplierNumerator, oldMultiplierDivider, newMultiplierNumerator, newMultiplierDivider)++`]
--


[.contract-item]
[[CommunityPool-initialize-contract-IContractManager-contract-ILinker-contract-IMessageProxyForMainnet-]]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityPool-initialize-contract-IContractManager-contract-ILinker-contract-IMessageProxyForMainnet->initialize</a>+++ `++initialize(++[.var-type]#++contract IContractManager++#++ ++[.var-name]#++contractManagerOfSkaleManagerValue++#++, ++[.var-type]#++contract ILinker++#++ ++[.var-name]#++linker++#++, ++[.var-type]#++contract IMessageProxyForMainnet++#++ ++[.var-name]#++messageProxyValue++#++)++` [.item-kind]#external#



[.contract-item]
[[CommunityPool-refundGasByUser-bytes32-address-payable-address-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityPool-refundGasByUser-bytes32-address-payable-address-uint256->refundGasByUser</a>+++ `++refundGasByUser(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++address payable++#++ ++[.var-name]#++node++#++, ++[.var-type]#++address++#++ ++[.var-name]#++user++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++gas++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Allows MessageProxyForMainnet to reimburse gas for transactions 
...
[.contract-item]
[[CommunityPool-refundGasBySchainWallet-bytes32-address-payable-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityPool-refundGasBySchainWallet-bytes32-address-payable-uint256->refundGasBySchainWallet</a>+++ `++refundGasBySchainWallet(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++address payable++#++ ++[.var-name]#++node++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++gas++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#



[.contract-item]
[[CommunityPool-rechargeUserWallet-string-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityPool-rechargeUserWallet-string-address->rechargeUserWallet</a>+++ `++rechargeUserWallet(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++, ++[.var-type]#++address++#++ ++[.var-name]#++user++#++)++` [.item-kind]#external#
...
[.contract-item]
[[CommunityPool-withdrawFunds-string-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityPool-withdrawFunds-string-uint256->withdrawFunds</a>+++ `++withdrawFunds(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++amount++#++)++` [.item-kind]#external#

Allows `msg.sender` to withdraw funds from their gas wallet.
...
[.contract-item]
[[CommunityPool-setMinTransactionGas-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityPool-setMinTransactionGas-uint256->setMinTransactionGas</a>+++ `++setMinTransactionGas(++[.var-type]#++uint256++#++ ++[.var-name]#++newMinTransactionGas++#++)++` [.item-kind]#external#

Allows `msg.sender` set the amount of gas that should be 
...
[.contract-item]
[[CommunityPool-setMultiplier-uint256-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityPool-setMultiplier-uint256-uint256->setMultiplier</a>+++ `++setMultiplier(++[.var-type]#++uint256++#++ ++[.var-name]#++newMultiplierNumerator++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++newMultiplierDivider++#++)++` [.item-kind]#external#
...
[.contract-item]
[[CommunityPool-getBalance-address-string-]]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityPool-getBalance-address-string->getBalance</a>+++ `++getBalance(++[.var-type]#++address++#++ ++[.var-name]#++user++#++, ++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Returns the amount of ETH on gas wallet for particular user.

[.contract-item]
[[CommunityPool-checkUserBalance-bytes32-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityPool-checkUserBalance-bytes32-address->checkUserBalance</a>+++ `++checkUserBalance(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++receiver++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether user is active and wallet was recharged for sufficient amount.

[.contract-item]
[[CommunityPool-getRecommendedRechargeAmount-bytes32-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityPool-getRecommendedRechargeAmount-bytes32-address->getRecommendedRechargeAmount</a>+++ `++getRecommendedRechargeAmount(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++receiver++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Checks whether passed amount is enough to recharge user wallet with current basefee.


[.contract-item]
[[CommunityPool-MinTransactionGasWasChanged-uint256-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityPool-MinTransactionGasWasChanged-uint256-uint256->MinTransactionGasWasChanged</a>+++ `++MinTransactionGasWasChanged(++[.var-type]#++uint256++#++ ++[.var-name]#++oldValue++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++newValue++#++)++` [.item-kind]#event#

Emitted when minimal value in gas for transactions from schain to mainnet was changed

[.contract-item]
[[CommunityPool-MultiplierWasChanged-uint256-uint256-uint256-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=CommunityPool-MultiplierWasChanged-uint256-uint256-uint256-uint256->MultiplierWasChanged</a>+++ `++MultiplierWasChanged(++[.var-type]#++uint256++#++ ++[.var-name]#++oldMultiplierNumerator++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++oldMultiplierDivider++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++newMultiplierNumerator++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++newMultiplierDivider++#++)++` [.item-kind]#event#

Emitted when basefee multiplier was changed
