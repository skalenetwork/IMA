...
:rechargeUserWallet: pass:normal[xref:#CommunityPool-rechargeUserWallet-string-[`++rechargeUserWallet++`]]
...
* {xref-CommunityPool-rechargeUserWallet-string-}[`++rechargeUserWallet(schainName)++`]
...
[.contract-item]
==== +++<a class="heading-anchor" area-hidden="true" name=CommunityPool-rechargeUserWallet-string->rechargeUserWallet</a>+++ `++rechargeUserWallet(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++)++` [.item-kind]#external#
