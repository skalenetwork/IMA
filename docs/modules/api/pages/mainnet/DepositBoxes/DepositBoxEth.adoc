...
:initialize: pass:normal[xref:#DepositBoxEth-initialize-contract-IContractManager-contract-Linker-contract-MessageProxyForMainnet-[`++initialize++`]]
...
* {xref-DepositBoxEth-initialize-contract-IContractManager-contract-Linker-contract-MessageProxyForMainnet-}[`++initialize(contractManagerOfSkaleManagerValue, linkerValue, messageProxyValue)++`]
--
