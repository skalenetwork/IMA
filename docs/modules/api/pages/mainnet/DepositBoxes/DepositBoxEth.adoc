...
:deposit: pass:normal[xref:#DepositBoxEth-deposit-string-address-[`++deposit++`]]
...
* {xref-DepositBoxEth-deposit-string-address-}[`++deposit(schainName, to)++`]
...
[.contract-item]
==== +++<a class="heading-anchor" area-hidden="true" name=DepositBoxEth-deposit-string-address->deposit</a>+++ `++deposit(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++, ++[.var-type]#++address++#++ ++[.var-name]#++to++#++)++` [.item-kind]#external#
