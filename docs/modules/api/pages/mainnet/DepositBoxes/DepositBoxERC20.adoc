...
:initializeAllTokensForSchain: pass:normal[xref:#DepositBoxERC20-initializeAllTokensForSchain-string-address---[`++initializeAllTokensForSchain++`]]
...
.Functions
--
* {xref-DepositBoxERC20-initializeAllTokensForSchain-string-address---}[`++initializeAllTokensForSchain(schainName, tokens)++`]
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=DepositBoxERC20-initializeAllTokensForSchain-string-address--->initializeAllTokensForSchain</a>+++ `++initializeAllTokensForSchain(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++, ++[.var-type]#++address[]++#++ ++[.var-name]#++tokens++#++)++` [.item-kind]#external#
