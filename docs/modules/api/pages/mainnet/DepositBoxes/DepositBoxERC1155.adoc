...
:initializeAllTokensForSchain: pass:normal[xref:#DepositBoxERC1155-initializeAllTokensForSchain-string-address---[`++initializeAllTokensForSchain++`]]
...
.Functions
--
* {xref-DepositBoxERC1155-initializeAllTokensForSchain-string-address---}[`++initializeAllTokensForSchain(schainName, tokens)++`]
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=DepositBoxERC1155-initializeAllTokensForSchain-string-address--->initializeAllTokensForSchain</a>+++ `++initializeAllTokensForSchain(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++, ++[.var-type]#++address[]++#++ ++[.var-name]#++tokens++#++)++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=DepositBoxERC1155-postMessage-bytes32-address-bytes->postMessage</a>+++ `++postMessage(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++sender++#++, ++[.var-type]#++bytes++#++ ++[.var-name]#++data++#++) → ++[.var-type]#++address++#++ ++[.var-name]#++receiver++#++++` [.item-kind]#external#
