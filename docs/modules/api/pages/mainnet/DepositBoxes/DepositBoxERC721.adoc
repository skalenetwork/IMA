...
:initializeAllTokensForSchain: pass:normal[xref:#DepositBoxERC721-initializeAllTokensForSchain-string-address---[`++initializeAllTokensForSchain++`]]
...
.Functions
--
* {xref-DepositBoxERC721-initializeAllTokensForSchain-string-address---}[`++initializeAllTokensForSchain(schainName, tokens)++`]
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=DepositBoxERC721-initializeAllTokensForSchain-string-address--->initializeAllTokensForSchain</a>+++ `++initializeAllTokensForSchain(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++, ++[.var-type]#++address[]++#++ ++[.var-name]#++tokens++#++)++` [.item-kind]#external#

Allows DEFAULT_ADMIN_ROLE to initialize token mapping
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=DepositBoxERC721-postMessage-bytes32-address-bytes->postMessage</a>+++ `++postMessage(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++sender++#++, ++[.var-type]#++bytes++#++ ++[.var-name]#++data++#++) → ++[.var-type]#++address++#++++` [.item-kind]#external#
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=DepositBoxERC721-getSchainToERC721-string-address->getSchainToERC721</a>+++ `++getSchainToERC721(++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++, ++[.var-type]#++address++#++ ++[.var-name]#++erc721OnMainnet++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#
