...
:schainToERC721: pass:normal[xref:#DepositBoxERC721-schainToERC721-mapping-bytes32----mapping-address----bool--[`++schainToERC721++`]]
...
:initialize: pass:normal[xref:#DepositBoxERC721-initialize-contract-IContractManager-contract-Linker-contract-MessageProxyForMainnet-[`++initialize++`]]
...
* {xref-DepositBoxERC721-initialize-contract-IContractManager-contract-Linker-contract-MessageProxyForMainnet-}[`++initialize(contractManagerOfSkaleManagerValue, linkerValue, messageProxyValue)++`]
--
