...
:initializeAllRegisteredContracts: pass:normal[xref:#MessageProxyForMainnet-initializeAllRegisteredContracts-bytes32-address---[`++initializeAllRegisteredContracts++`]]
...
.Functions
--
* {xref-MessageProxyForMainnet-initializeAllRegisteredContracts-bytes32-address---}[`++initializeAllRegisteredContracts(schainHash, contracts)++`]
...
[.contract-item]
== +++<a class="heading-anchor" area-hidden="true" name=MessageProxyForMainnet-initializeAllRegisteredContracts-bytes32-address--->initializeAllRegisteredContracts</a>+++ `++initializeAllRegisteredContracts(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++address[]++#++ ++[.var-name]#++contracts++#++)++` [.item-kind]#external#

Allows DEFAULT_ADMIN_ROLE to initialize registered contracts
