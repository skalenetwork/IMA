...
const PACKAGE_JSON_TEMPLATE = {
    ...
    license: "AGPL-3.0",
    bugs: {
        url: "https://github.com/skalenetwork/ima/issues"
    },
    homepage: "https://github.com/skalenetwork/ima#readme",
    files: [
        "ethers-v5/**/*",
        "ethers-v6/**/*",
        "viem/**/*",
...
const README_CONTENT = `# @skalenetwork/ima-types
...
- **ethers v5** - via \`@skalenetwork/ima-types/ethers-v5\`
- **ethers v6** - via \`@skalenetwork/ima-types/ethers-v6\`
- **viem** - via \`@skalenetwork/ima-types/viem\`
- **Raw ABIs** - via \`@skalenetwork/ima-types/abi/*\`
...
For usage examples, contract documentation, and more details, see the [Skale Manager repository](https://github.com/skalenetwork/ima).
...
async function main() {
    console.log("========================================");
    console.log("Building @skalenetwork/ima-types");
    console.log("========================================\n");
