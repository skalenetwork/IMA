...
def check_key_storage(owner_address):
    ...
    print('KeyStorage checks')
    assert key_storage.functions.getRoleMember(KeyStorageGenerator.DEFAULT_ADMIN_ROLE, 0).call() == owner_address
    assert key_storage.functions.hasRole(KeyStorageGenerator.DEFAULT_ADMIN_ROLE, owner_address).call()
