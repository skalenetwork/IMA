...
contract DepositBoxERC20 is IMAConnected, IMainnetContract {
     ...
     */
    function addSchainContract(string calldata schainID, address newTokenManagerERC20Address) external override {
        require(
