...
async function deploy(deployer, network) {
    ...
    await deployer.deploy(MessageProxy, "Mainnet", /*jsonData.contract_manager_address*/ "0x0000000000000000000000000000000000000000", {gas: gasLimit}).then(async function() {
