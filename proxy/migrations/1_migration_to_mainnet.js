...
let ERC20Module = artifacts.require("./ERC20Module.sol");
...
async function deploy(deployer) {
    ...
    await deployer.deploy(MessageProxy, "Mainnet", {gas: 8000000}).then(async function() {
        ...
        await deployer.deploy(ERC20Module, inst.address, {gas: 8000000});
        await inst.setContract("ERC20Module", ERC20Module.address);
    ...
    let jsonObject = {
        ...
        erc20_module_address: ERC20Module.address,
        erc20_module_abi: ERC20Module.abi,
