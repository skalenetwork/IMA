...
const { add } = require("../npms/skale-log/log");
...
const address = "0xb2DD6f3FE1487daF2aC8196Ae8639DDC2763b871";
const message1 = {
    amount: 3,
    data: "0x11",
...
console.log("vvv");
console.log(imaBLS.compose_summary_message_to_sign(messages, true));
console.log("^^^");
