...
function ima_common_init() {
    ...
    // ima_linker_address            --> ima_linker_abi
    ...
    imaState.jo_ima_linker = new imaState.w3_main_net.eth.Contract( imaState.joTrufflePublishResult_main_net.ima_linker_abi, imaState.joTrufflePublishResult_main_net.ima_linker_address ); // only main net
    ...
    log.write( cc.info( "Main-net " ) + cc.sunny( "IMALinker" ) + cc.info( "        address is....." ) + cc.bright( imaState.jo_ima_linker.options.address ) + "\n" );
