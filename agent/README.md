...
We will use networks called **MainNet** and **S-Chain** in this documentation:
    ...
    let privateKey_main_net = process.env.INSECURE_PRIVATE_KEY_FOR_ETHEREUM;
...
Fourth, export required environment variables:
    ...
    export INSECURE_PRIVATE_KEY_FOR_ETHEREUM="<YOUR_PRIVATE_KEY_HERE>"
...
Notice: ACCOUNT_FOR_ETHEREUM address corresponds to INSECURE_PRIVATE_KEY_FOR_ETHEREUM private key, ACCOUNT_FOR_SCHAIN address corresponds to INSECURE_PRIVATE_KEY_FOR_SCHAIN private key.
