...
We will use networks called **MainNet** and **S-Chain** in this documentation:
    ...
    let privateKey_main_net = process.env.INSECURE_PRIVATE_KEY_FOR_ETHEREUMM;
...
Fourth, export required environment variables:
    ...
    export NETWORK_FOR_ETHEREUMM="mainnet"
    export INSECURE_PRIVATE_KEY_FOR_ETHEREUMM="<YOUR_PRIVATE_KEY_HERE>"
    ...
    export ACCOUNT_FOR_ETHEREUMM="<ACCOUNT_ADDRESS_HERE>"
    export ACCOUNT_FOR_SCHAIN=""<ACCOUNT_ADDRESS_HERE>"

Notice: ACCOUNT_FOR_ETHEREUMM address corresponds to INSECURE_PRIVATE_KEY_FOR_ETHEREUMM private key, ACCOUNT_FOR_SCHAIN address corresponds to INSECURE_PRIVATE_KEY_FOR_SCHAIN private key.
...
You can check whether **IMA** is already bound with:
    ...
    node ./main.js --verbose=9 \
        ...
        --key-main-net=$INSECURE_PRIVATE_KEY_FOR_ETHEREUMM \
...
Performed with the **--s2m-payment** command line option:
    ...
    node ./main.js --verbose=9 \
        ...
        --abi-main-net=../proxy/data/proxyMainnet.json \
        --abi-s-chain=../proxy/data/proxySchain_Bob.json \
        --address-main-net=$ACCOUNT_FOR_ETHEREUMM \
        --key-s-chain=$INSECURE_PRIVATE_KEY_FOR_SCHAIN
